...
class PollyClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.can_paginate)
    ...
    def delete_lexicon(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.delete_lexicon)
    ...
    def describe_voices(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.describe_voices)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.generate_presigned_url)
    ...
    def get_lexicon(self, *, Name: str) -> GetLexiconOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.get_lexicon)
    ...
    def get_speech_synthesis_task(self, *, TaskId: str) -> GetSpeechSynthesisTaskOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.get_speech_synthesis_task)
    ...
    def list_lexicons(self, *, NextToken: str = ...) -> ListLexiconsOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.list_lexicons)
    ...
    def list_speech_synthesis_tasks(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.list_speech_synthesis_tasks)
    ...
    def put_lexicon(self, *, Name: str, Content: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.put_lexicon)
    ...
    def start_speech_synthesis_task(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.start_speech_synthesis_task)
    ...
    def synthesize_speech(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Client.synthesize_speech)
    ...
    def get_paginator(self, operation_name: Literal["describe_voices"]) -> DescribeVoicesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Paginator.DescribeVoices)
    ...
    def get_paginator(self, operation_name: Literal["list_lexicons"]) -> ListLexiconsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Paginator.ListLexicons)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/polly.html#Polly.Paginator.ListSpeechSynthesisTasks)
