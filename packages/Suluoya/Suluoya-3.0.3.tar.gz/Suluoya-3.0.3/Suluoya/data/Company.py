...
class FinancialStatements(object):
    ...
    def request(self, urls):
        ...
        return pd.concat(result_list).set_index('报告日期')
    ...
    def balance(self):
        '''资产负债表'''
        return self.request([i.replace('cwbbzy', 'zzfzb') for i in self.statement_urls])
...
if __name__ == '__main__':
    ...
    test = fs.profit_info()
    fs.save(test, 'lalal', "C:\\Users\\19319\\Desktop\\")
