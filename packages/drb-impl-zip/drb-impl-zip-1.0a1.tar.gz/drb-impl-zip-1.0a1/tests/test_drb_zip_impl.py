...
class TestDrbZip(unittest.TestCase):
    ...
    def test_has_impl(self):
        ...
        node_manifest = first_node.get_named_child(SENTINEL_1_MANIFEST_FAKE,
                                                   occurrence=1)
        self.assertTrue(node_manifest.has_impl(zipfile.ZipExtFile))
        self.assertTrue(node_manifest.has_impl(io.BufferedIOBase))
        node_support = first_node.get_named_child(SENTINEL_1_SUPPORT,
                                                  occurrence=1)
    ...
    def test_add_attribute(self):
        ...
        first_child = node.get_child_at(0)
    ...
    def test_remove_attribute(self):
        ...
        node = first_child
        with self.assertRaises(NotImplementedError):
            node.remove_attribute(DrbZipAttributeNames.DIRECTORY.value)
