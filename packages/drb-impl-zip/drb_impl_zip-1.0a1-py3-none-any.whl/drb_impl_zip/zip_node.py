...
class DrbZipNode(DrbLogicalNode):
    ...
    def _get_file_list(self):
        return self._parent._get_file_list()
    ...
    def get_impl(self, impl: type) -> Any:
        if self.has_impl(impl):
            return self._parent._open_entry(self._zip_info)
