...
class CLICreateInput(BaseModel):
    ...
    _is_credentials_registered = root_validator(allow_reuse=True)(Validator.is_credentials_registered)
...
class CLIScaleInput(BaseModel):
    ...
    _artifact_dir_exists = root_validator(allow_reuse=True)(Validator.artifact_dir_exists)

    _tfstate_exists = root_validator(allow_reuse=True)(Validator.tfstate_exists)
