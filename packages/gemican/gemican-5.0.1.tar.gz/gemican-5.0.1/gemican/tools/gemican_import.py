...
from gemican.log import init
from gemican.settings import read_settings
from gemican.utils import SafeDatetime, slugify
...
def wp2fields(xml, wp_custpost=False):
    """Opens a wordpress XML file, and yield Gemican fields"""
...
def blogger2fields(xml):
    """Opens a blogger XML file, and yield Gemican fields"""
...
def dc2fields(file):
    """Opens a Dotclear export file, and yield gemican fields"""
    try:
        from bs4 import BeautifulSoup
    except ImportError:
...
def feed2fields(file):
    """Read a feed and yield gemican fields"""
    import feedparser
...
def main():
    ...
    parser.add_argument(
        ...
        help='Disable storing slugs from imported posts within output. '
             'With this disabled, your Gemican URLs may not be consistent '
    ...
    # init logging
    init()
    fields2gemican(fields, args.markup, args.output,
