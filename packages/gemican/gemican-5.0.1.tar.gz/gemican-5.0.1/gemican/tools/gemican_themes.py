...
try:
    ...
    err('Cannot import gemican.\nYou must '
        'install Gemican in order to run this script.',
        -1)
...
_THEMES_PATH = os.path.join(
    os.path.dirname(
        os.path.abspath(gemican.__file__)
    ),
    'themes'
)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="""Install themes for Gemican""")
    ...
    excl.add_argument(
        ...
        version='gemican-themes v{}'.format(__version__),
