...
from gemican.generators import (ArticlesGenerator, GemicanTemplateNotFound,
                                Generator, PagesGenerator, StaticGenerator,
                                TemplatePagesGenerator)
from gemican.tests.support import (can_symlink, get_context, get_settings,
                                   unittest)
...
class TestGenerator(unittest.TestCase):
    ...
    def test_bad_prefix(self):
        ...
        """
        self.assertRaises(GemicanTemplateNotFound, self.generator.get_template,
                          '!UNKNOWN/authors')
...
class TestPageGenerator(unittest.TestCase):
    ...
    def test_static_and_attach_links_on_generated_pages(self):
        ...
        self.assertIn('gemican/tests/TestPages/image0.jpg',
                      context['static_links'])
        self.assertIn('gemican/tests/TestPages/image1.jpg',
                      context['static_links'])
...
class TestTemplatePagesGenerator(unittest.TestCase):
    ...
    def setUp(self):
        self.temp_content = mkdtemp(prefix='gemicantests.')
