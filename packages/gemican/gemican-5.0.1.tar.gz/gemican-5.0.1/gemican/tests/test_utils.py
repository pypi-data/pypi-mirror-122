...
from gemican import utils
from gemican.generators import TemplatePagesGenerator
from gemican.readers import Readers
from gemican.settings import read_settings
from gemican.tests.support import (LoggedTestCase, get_article,
...
class TestUtils(LoggedTestCase):
    ...
    def test_filesystemwatcher(self):
        ...
        from gemican.utils import logger
...
class TestCopy(unittest.TestCase):
    ...
    def setUp(self):
        self.root_dir = mkdtemp(prefix='gemicantests.')
...
class TestDateFormatter(unittest.TestCase):
    ...
    def test_french_locale(self):
        ...
        with utils.gemican_open(output_path) as output_file:
