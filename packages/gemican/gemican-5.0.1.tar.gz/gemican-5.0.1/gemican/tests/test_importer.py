...
from gemican.tests.support import (mute, skipIfNoExecutable, temporary_folder,
                                   unittest)
from gemican.tools.gemican_import import (blogger2fields, build_header,
                                          build_markdown_header,
                                          decode_wp_content,
                                          download_attachments, fields2gemican,
                                          get_attachments, wp2fields)
from gemican.utils import path_to_file_url, slugify
...
class TestWordpressXmlImporter(unittest.TestCase):
    ...
    def test_dirpage_directive_for_page_kind(self):
        silent_f2p = mute(True)(fields2gemican)
            ...
            if post is None:
                expected = {
                    ('https://upload.wikimedia.org/wikipedia/commons/'
                     'thumb/2/2c/Gemican_lakes_entrance02.jpg/'
                     '240px-Gemican_lakes_entrance02.jpg')
                }
