...
from gemican.contents import Article, Author, Category, Page, Static
from gemican.plugins.signals import content_object_init
...
class TestBase(LoggedTestCase):
    ...
    def _disable_limit_filter(self):
        from gemican.contents import logger
...
class TestPage(TestBase):
    ...
    def test_intrasite_link(self):
        ...
        p = Page(**args)
        # This is called implicitly from all generators and Gemican.run() once
