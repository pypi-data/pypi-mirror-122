...
from gemican.settings import (DEFAULT_CONFIG, DEFAULT_THEME,
...
class TestSettingsConfiguration(unittest.TestCase):
    ...
    def test_defaults_not_overwritten(self):
        # This assumes 'SITENAME': 'A Gemican Blog'
        settings = read_settings(None)
        settings['SITENAME'] = 'Not a Gemican Blog'
    ...
    def test_theme_settings_exceptions(self):
        ...
        # Check that theme lookup in "gemican/themes" functions as expected
