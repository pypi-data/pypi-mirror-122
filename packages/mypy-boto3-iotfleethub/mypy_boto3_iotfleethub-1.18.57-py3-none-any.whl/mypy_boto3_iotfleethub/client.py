...
class IoTFleetHubClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.can_paginate)
    ...
    def create_application(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.create_application)
    ...
    def delete_application(self, *, applicationId: str, clientToken: str = ...) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.delete_application)
    ...
    def describe_application(self, *, applicationId: str) -> DescribeApplicationResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.describe_application)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.generate_presigned_url)
    ...
    def list_applications(self, *, nextToken: str = ...) -> ListApplicationsResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.list_applications)
    ...
    def list_tags_for_resource(self, *, resourceArn: str) -> ListTagsForResourceResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.list_tags_for_resource)
    ...
    def tag_resource(self, *, resourceArn: str, tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.tag_resource)
    ...
    def untag_resource(self, *, resourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.untag_resource)
    ...
    def update_application(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Client.update_application)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/iotfleethub.html#IoTFleetHub.Paginator.ListApplications)
