...
class Binomial(Distribution):
    ...
    def __add__(self, other):
        ...
        resultant_binomail = Binomial()
        resultant_binomail.n = self.n + other.n
        resultant_binomail.p = self.p
        resultant_binomail.mean = self.calculate_mean()
        resultant_binomail.stdev = self.calculate_stdev()
        return resultant_binomail
