...
class FuseApi(FusionDS.DSAccessBase):
    ...
    def __init__(self, baseUrl, key):
        """default contstuctor"""
        super().__init__(baseUrl, key)

    def FuseElements(self, typeUid):
        """Gets fuse elements"""
        fa = REST.ApiClient(self._baseUrl(), self._getAccess())
        feReq = fa.Post('FusionBusApi/d17e86e7-0107-41f5-85a9-25555480e858/FuseElements', 
                        {'typeUid': typeUid})
        return feReq.json()
    ...
    def FuseTypes(self):
        ...
        fa = REST.ApiClient(self._baseUrl(), self._getAccess())
        faReq = fa.Post('/FusionBusApi/d17e86e7-0107-41f5-85a9-25555480e858/FuseTypes')
        return faReq.json()

    def CreateElement(self, typeUid, entityUid, entityId, context):
        """Create fuse element"""
        fa = REST.ApiClient(self._baseUrl(), self._getAccess())
        faReq = fa.Post('/FusionBusApi/d17e86e7-0107-41f5-85a9-25555480e858/CreateElement',
                        jsonParams=
                            {'TypeUid' : typeUid,
                             'EntityUid': entityUid,
                             'EntityId': entityId,
