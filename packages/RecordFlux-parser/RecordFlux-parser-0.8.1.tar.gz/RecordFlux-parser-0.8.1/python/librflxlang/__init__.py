...
class GrammarRule(_Enum):
    ...
    then_rule = 'then_rule'
    component_type_argument_rule = 'component_type_argument_rule'
    null_component_item_rule = 'null_component_item_rule'
...
class Component(RFLXNode):
    ...
    def f_identifier(self):
        ...
        result = self._eval_astnode_field(_component_f_identifier)
    ...
    def f_type_identifier(self):
        ...
        result = self._eval_astnode_field(_component_f_type_identifier)
    ...
    def f_type_arguments(self):
        """
        :rtype: ComponentTypeArgumentList
        """
        

        

        result = self._eval_astnode_field(_component_f_type_arguments)
    ...
    def f_aspects(self):
        ...
        result = self._eval_astnode_field(_component_f_aspects)
    ...
    def f_condition(self):
        ...
        * Variable
        ...
        result = self._eval_astnode_field(_component_f_condition)
    ...
    def f_thens(self):
        ...
        result = self._eval_astnode_field(_component_f_thens)
...
class ComponentTypeArgument(RFLXNode):
    ...
    def f_identifier(self):
        ...
        result = self._eval_astnode_field(_component_type_argument_f_identifier)
    ...
    def f_expression(self):
        ...
        * Variable
        ...
        result = self._eval_astnode_field(_component_type_argument_f_expression)
    ...
    _kind_name = 'ComponentTypeArgument'
...
class Components(RFLXNode):
    ...
    def f_initial_component(self):
        ...
        result = self._eval_astnode_field(_components_f_initial_component)
    ...
    def f_components(self):
        ...
        result = self._eval_astnode_field(_components_f_components)
...
class NullComponent(RFLXNode):
    ...
    def f_then(self):
        ...
        result = self._eval_astnode_field(_null_component_f_then)
...
class ComponentList(RFLXNodeBaseList):
    """
    List of Component.
    """
    __slots__ = []
...
class ComponentTypeArgumentList(RFLXNodeBaseList):
    """
    List of ComponentTypeArgument.
    """
    __slots__ = []
    ...
    _kind_name = 'ComponentTypeArgumentList'
...
class MessageTypeDef(AbstractMessageTypeDef):
    ...
    def f_components(self):
        ...
        result = self._eval_astnode_field(_message_type_def_f_components)
...
_component_f_identifier = _import_func(
    'rflx_component_f_identifier',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_component_f_type_identifier = _import_func(
    'rflx_component_f_type_identifier',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_component_f_type_arguments = _import_func(
    'rflx_component_f_type_arguments',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_component_f_aspects = _import_func(
    'rflx_component_f_aspects',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_component_f_condition = _import_func(
    'rflx_component_f_condition',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_component_f_thens = _import_func(
    'rflx_component_f_thens',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_component_type_argument_f_identifier = _import_func(
    'rflx_component_type_argument_f_identifier',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_component_type_argument_f_expression = _import_func(
    'rflx_component_type_argument_f_expression',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_components_f_initial_component = _import_func(
    'rflx_components_f_initial_component',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_components_f_components = _import_func(
    'rflx_components_f_components',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
...
_null_component_f_then = _import_func(
    'rflx_null_component_f_then',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
...
_message_type_def_f_components = _import_func(
    'rflx_message_type_def_f_components',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
...
_kind_to_astnode_cls = {
    ...
    27: ChecksumAssoc,
    28: Component,
    29: ComponentTypeArgument,
    30: Components,
    31: RefinementDecl,
    32: SessionDecl,
    33: TypeDecl,
    34: Description,
    35: ElementValueAssoc,
    36: Attribute,
    37: BinOp,
    38: Binding,
    39: Call,
    ...
    85: ComponentList,
    86: ComponentTypeArgumentList,
    87: ConditionalTransitionList,
    88: ContextItemList,
    89: DeclarationList,
    90: ElementValueAssocList,
    91: ExprList,
    92: FormalDeclList,
    93: LocalDeclList,
    94: MessageAggregateAssociationList,
    95: NumericLiteralList,
    96: ParameterList,
    97: StateList,
    98: StatementList,
    99: TermAssocList,
    100: ThenNodeList,
    101: UnqualifiedIDList,
    102: SessionAspects,
    103: Specification,
    104: State,
    105: Assignment,
