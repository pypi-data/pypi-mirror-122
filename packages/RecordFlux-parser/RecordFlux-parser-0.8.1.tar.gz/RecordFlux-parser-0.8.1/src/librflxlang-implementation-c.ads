...
procedure rflx_rflx_node_array_dec_ref (A : Internal_Entity_Array_Access)
   ...
   function rflx_component_f_identifier
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_component_f_identifier";
   ...
   function rflx_component_f_type_identifier
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_component_f_type_identifier";
   ...
   function rflx_component_f_type_arguments
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_component_f_type_arguments";
   ...
   function rflx_component_f_aspects
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_component_f_aspects";
   ...
   function rflx_component_f_condition
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_component_f_condition";
   --  This field can contain one of the following nodes:
   --
   --  * Attribute
   --
   ...
   function rflx_component_f_thens
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_component_f_thens";
   ...
   function rflx_component_type_argument_f_identifier
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_component_type_argument_f_identifier";
   ...
   function rflx_component_type_argument_f_expression
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_component_type_argument_f_expression";
   --  This field can contain one of the following nodes:
   --
   --  * Attribute
   --
   ...
   function rflx_components_f_initial_component
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_components_f_initial_component";
   ...
   function rflx_components_f_components
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_components_f_components";
   ...
   function rflx_null_component_f_then
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_null_component_f_then";
   ...
   function rflx_message_type_def_f_components
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_message_type_def_f_components";
   ...
   function rflx_message_type_def_f_checksums
     (Node : rflx_base_entity_Ptr;
      ...
      with Export        => True,
           Convention    => C,
           External_name => "rflx_message_type_def_f_checksums";
