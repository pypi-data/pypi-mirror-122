...
private package Librflxlang.Introspection_Implementation is
   ...
   --  Descriptors for syntax fields
      ...
      Desc_For_Component_F_Identifier : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 12,
            Field_Type  => Common.UnqualifiedID_Type_Id,
            Name        => "f_identifier"
      ...
      Desc_For_Component_F_Type_Identifier : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 17,
      ...
      Desc_For_Component_F_Type_Arguments : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 16,
            Field_Type  => Common.Component_Type_Argument_List_Type_Id,
            Name        => "f_type_arguments"
         );
      
      Desc_For_Component_F_Aspects : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 9,
      ...
      Desc_For_Component_F_Condition : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 11,
            Field_Type  => Common.Expr_Type_Id,
            Name        => "f_condition"
      ...
      Desc_For_Component_F_Thens : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 7,
      ...
      Desc_For_Component_Type_Argument_F_Identifier : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 12,
            Field_Type  => Common.UnqualifiedID_Type_Id,
            Name        => "f_identifier"
      ...
      Desc_For_Component_Type_Argument_F_Expression : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 12,
            Field_Type  => Common.Expr_Type_Id,
            Name        => "f_expression"
      ...
      Desc_For_Components_F_Initial_Component : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 19,
            Field_Type  => Common.Null_Component_Type_Id,
            Name        => "f_initial_component"
         );
      
      Desc_For_Components_F_Components : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 12,
      ...
      Desc_For_Null_Component_F_Then : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 6,
      ...
      Desc_For_Message_Type_Def_F_Components : aliased constant
         Syntax_Field_Descriptor := (
            Name_Length => 12,
            Field_Type  => Common.Components_Type_Id,
            Name        => "f_components"
         );
   ...
   Component_F_Identifier_For_Component : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Component_F_Identifier

         , Index => 1
   );
   Component_F_Type_Identifier_For_Component : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Component_F_Type_Identifier

         , Index => 2
   );
   Component_F_Type_Arguments_For_Component : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Component_F_Type_Arguments

         , Index => 3
   );
   Component_F_Aspects_For_Component : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Component_F_Aspects

         , Index => 4
   );
   Component_F_Condition_For_Component : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Component_F_Condition

         , Index => 5
   );
   Component_F_Thens_For_Component : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Component_F_Thens

         , Index => 6
   );

   Desc_For_Component : aliased constant Node_Type_Descriptor := (
      Is_Abstract       => False,
      Derivations_Count => 0,
      Fields_Count      => 6,
      Properties_Count  => 0,
      ...
      DSL_Name => To_Unbounded_String ("Component"),

      Inherited_Fields => 0,
      Fields           => (
            1 => Component_F_Identifier_For_Component'Access, 2 => Component_F_Type_Identifier_For_Component'Access, 3 => Component_F_Type_Arguments_For_Component'Access, 4 => Component_F_Aspects_For_Component'Access, 5 => Component_F_Condition_For_Component'Access, 6 => Component_F_Thens_For_Component'Access
      ),
   ...
   Component_Type_Argument_F_Identifier_For_Component_Type_Argument : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Component_Type_Argument_F_Identifier

         , Index => 1
   );
   Component_Type_Argument_F_Expression_For_Component_Type_Argument : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Component_Type_Argument_F_Expression

         , Index => 2
   );

   Desc_For_Component_Type_Argument : aliased constant Node_Type_Descriptor := (
      Is_Abstract       => False,
      Derivations_Count => 0,
      Fields_Count      => 2,
      Properties_Count  => 0,
      ...
      DSL_Name => To_Unbounded_String ("ComponentTypeArgument"),

      Inherited_Fields => 0,
      Fields           => (
            1 => Component_Type_Argument_F_Identifier_For_Component_Type_Argument'Access, 2 => Component_Type_Argument_F_Expression_For_Component_Type_Argument'Access
      ),
      ...
      , Kind => RFLX_Component_Type_Argument
   );
   

   Components_F_Initial_Component_For_Components : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Components_F_Initial_Component

         , Index => 1
   );
   Components_F_Components_For_Components : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Components_F_Components

         , Index => 2
   );

   Desc_For_Components : aliased constant Node_Type_Descriptor := (
      Is_Abstract       => False,
      Derivations_Count => 0,
      Fields_Count      => 2,
      Properties_Count  => 0,
      ...
      DSL_Name => To_Unbounded_String ("Components"),

      Inherited_Fields => 0,
      Fields           => (
            1 => Components_F_Initial_Component_For_Components'Access, 2 => Components_F_Components_For_Components'Access
      ),
   ...
   Null_Component_F_Then_For_Null_Component : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Null_Component_F_Then

         , Index => 1
   );

   Desc_For_Null_Component : aliased constant Node_Type_Descriptor := (
      Is_Abstract       => False,
      Derivations_Count => 0,
      Fields_Count      => 1,
      Properties_Count  => 0,
      ...
      DSL_Name => To_Unbounded_String ("NullComponent"),

      Inherited_Fields => 0,
      Fields           => (
            1 => Null_Component_F_Then_For_Null_Component'Access
      ),
   ...
   Desc_For_RFLX_Node_Base_List : aliased constant Node_Type_Descriptor := (
      ...
      Base_Type   => Common.RFLX_Node_Type_Id,
      Derivations =>
         (1 => Common.Parameter_List_Type_Id, 2 => Common.Message_Aggregate_Association_List_Type_Id, 3 => Common.Numeric_Literal_List_Type_Id, 4 => Common.Local_Decl_List_Type_Id, 5 => Common.Statement_List_Type_Id, 6 => Common.Conditional_Transition_List_Type_Id, 7 => Common.Formal_Decl_List_Type_Id, 8 => Common.State_List_Type_Id, 9 => Common.Declaration_List_Type_Id, 10 => Common.UnqualifiedID_List_Type_Id, 11 => Common.Element_Value_Assoc_List_Type_Id, 12 => Common.Aspect_List_Type_Id, 13 => Common.Component_Type_Argument_List_Type_Id, 14 => Common.Then_Node_List_Type_Id, 15 => Common.Component_List_Type_Id, 16 => Common.Base_Checksum_Val_List_Type_Id, 17 => Common.Checksum_Assoc_List_Type_Id, 18 => Common.Context_Item_List_Type_Id, 19 => Common.Channel_Attribute_List_Type_Id, 20 => Common.Expr_List_Type_Id, 21 => Common.Term_Assoc_List_Type_Id),
   ...
   Desc_For_Component_List : aliased constant Node_Type_Descriptor := (
      ...
      DSL_Name => To_Unbounded_String ("Component.list"),
      ...
      , Kind => RFLX_Component_List
   );
   


   Desc_For_Component_Type_Argument_List : aliased constant Node_Type_Descriptor := (
      Is_Abstract       => False,
      Derivations_Count => 0,
      Fields_Count      => 0,
      Properties_Count  => 0,
      ...
      DSL_Name => To_Unbounded_String ("ComponentTypeArgument.list"),
      ...
      , Kind => RFLX_Component_Type_Argument_List
   );
   ...
   Message_Type_Def_F_Components_For_Message_Type_Def : aliased constant Node_Field_Descriptor
   := (
      Is_Abstract_Or_Null => False,
      Field               => Message_Type_Def_F_Components
   ...
   Desc_For_Message_Type_Def : aliased constant Node_Type_Descriptor := (
      ...
      Inherited_Fields => 0,
      Fields           => (
            1 => Message_Type_Def_F_Components_For_Message_Type_Def'Access, 2 => Message_Type_Def_F_Checksums_For_Message_Type_Def'Access
      ),
