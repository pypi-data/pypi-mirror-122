...
package body Librflxlang.Implementation.C is
   ...
   function rflx_component_f_identifier
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Component_Range then
         ...
         declare
            ...
            Result : Bare_UnqualifiedID;
         begin
            Result := Component_F_Identifier (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_component_f_identifier;
   ...
   function rflx_component_f_type_identifier
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Component_Range then
         ...
         declare
            ...
            Result : Bare_ID;
         begin
            Result := Component_F_Type_Identifier (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_component_f_type_identifier;
   ...
   function rflx_component_f_type_arguments
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Component_Range then
         ...
         declare
            ...
            Result : Bare_Component_Type_Argument_List;
         begin
            Result := Component_F_Type_Arguments (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_component_f_type_arguments;
   ...
   function rflx_component_f_aspects
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Component_Range then
         ...
         begin
            Result := Component_F_Aspects (Unwrapped_Node);
   ...
   function rflx_component_f_condition
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Component_Range then
         ...
         declare
            ...
            Result : Bare_Expr;
         begin
            Result := Component_F_Condition (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_component_f_condition;
   ...
   function rflx_component_f_thens
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Component_Range then
         ...
         begin
            Result := Component_F_Thens (Unwrapped_Node);
   ...
   function rflx_component_type_argument_f_identifier
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Component_Type_Argument_Range then
         ...
         declare
            ...
            Result : Bare_UnqualifiedID;
         begin
            Result := Component_Type_Argument_F_Identifier (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_component_type_argument_f_identifier;
   ...
   function rflx_component_type_argument_f_expression
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Component_Type_Argument_Range then
         ...
         declare
            ...
            Result : Bare_Expr;
         begin
            Result := Component_Type_Argument_F_Expression (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_component_type_argument_f_expression;
   ...
   function rflx_components_f_initial_component
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Components_Range then

         declare
            

            Result : Bare_Null_Component;
         begin
            Result := Components_F_Initial_Component (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_components_f_initial_component;
   ...
   function rflx_components_f_components
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Components_Range then
         ...
         begin
            Result := Components_F_Components (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_components_f_components;
   ...
   function rflx_null_component_f_then
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Null_Component_Range then
         ...
         begin
            Result := Null_Component_F_Then (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_null_component_f_then;
   ...
   function rflx_message_type_def_f_components
     (Node : rflx_base_entity_Ptr;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in RFLX_Message_Type_Def_Range then
         ...
         declare
            ...
            Result : Bare_Components;
         begin
            Result := Message_Type_Def_F_Components (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end rflx_message_type_def_f_components;
