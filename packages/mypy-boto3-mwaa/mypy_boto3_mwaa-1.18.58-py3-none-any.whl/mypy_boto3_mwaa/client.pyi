...
class MWAAClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.can_paginate)
    ...
    def create_cli_token(self, *, Name: str) -> CreateCliTokenResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.create_cli_token)
    ...
    def create_environment(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.create_environment)
    ...
    def create_web_login_token(self, *, Name: str) -> CreateWebLoginTokenResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.create_web_login_token)
    ...
    def delete_environment(self, *, Name: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.delete_environment)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.generate_presigned_url)
    ...
    def get_environment(self, *, Name: str) -> GetEnvironmentOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.get_environment)
    ...
    def list_environments(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.list_environments)
    ...
    def list_tags_for_resource(self, *, ResourceArn: str) -> ListTagsForResourceOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.list_tags_for_resource)
    ...
    def publish_metrics(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.publish_metrics)
    ...
    def tag_resource(self, *, ResourceArn: str, Tags: Mapping[str, str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.tag_resource)
    ...
    def untag_resource(self, *, ResourceArn: str, tagKeys: Sequence[str]) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.untag_resource)
    ...
    def update_environment(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Client.update_environment)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/mwaa.html#MWAA.Paginator.ListEnvironments)
