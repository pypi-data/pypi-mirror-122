...
- container (string; optional):
    ...
    the container the Slide is transitioning from.
...
- unmountOnExit (boolean; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, appear=Component.UNDEFINED, direction=Component.UNDEFINED, enter=Component.UNDEFINED, exit=Component.UNDEFINED, mountOnEnter=Component.UNDEFINED, unmountOnExit=Component.UNDEFINED, id=Component.UNDEFINED, style=Component.UNDEFINED, container=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'appear', 'container', 'direction', 'enter', 'exit', 'in', 'mountOnEnter', 'style', 'unmountOnExit']
        self._type = 'Slide'
        self._namespace = 'materialdashboard'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'appear', 'container', 'direction', 'enter', 'exit', 'in', 'mountOnEnter', 'style', 'unmountOnExit']
