...
- color (a value equal to: "inherit", "action", "disabled", "success", "info", "warning", "error", "primary", "secondary"; optional):
...
- viewBox (string; optional):
    ...
    def __init__(self, children=None, color=Component.UNDEFINED, fontSize=Component.UNDEFINED, htmlColor=Component.UNDEFINED, shapeRendering=Component.UNDEFINED, titleAccess=Component.UNDEFINED, viewBox=Component.UNDEFINED, className=Component.UNDEFINED, id=Component.UNDEFINED, classes=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'className', 'classes', 'color', 'fontSize', 'htmlColor', 'shapeRendering', 'style', 'titleAccess', 'viewBox']
        self._type = 'SvgIcon'
        self._namespace = 'materialdashboard'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'classes', 'color', 'fontSize', 'htmlColor', 'shapeRendering', 'style', 'titleAccess', 'viewBox']
