...
- variant (a value equal to: "button", "caption", "h1", "h2", "h3", "h4", "h5", "h6", "inherit", "subtitle1", "subtitle2", "body1", "body2", "overline"; optional):
    ...
    @_explicitize_args
    def __init__(self, children=None, variant=Component.UNDEFINED, align=Component.UNDEFINED, gutterBottom=Component.UNDEFINED, noWrap=Component.UNDEFINED, paragraph=Component.UNDEFINED, className=Component.UNDEFINED, id=Component.UNDEFINED, classes=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'align', 'className', 'classes', 'gutterBottom', 'noWrap', 'paragraph', 'style', 'variant']
        self._type = 'DialogContentText'
        self._namespace = 'materialdashboard'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'align', 'className', 'classes', 'gutterBottom', 'noWrap', 'paragraph', 'style', 'variant']
