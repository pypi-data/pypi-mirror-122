...
class STSClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client)
    ...
    def assume_role(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.assume_role)
    ...
    def assume_role_with_saml(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.assume_role_with_saml)
    ...
    def assume_role_with_web_identity(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.assume_role_with_web_identity)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.can_paginate)
    ...
    def decode_authorization_message(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.decode_authorization_message)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.generate_presigned_url)
    ...
    def get_access_key_info(self, *, AccessKeyId: str) -> GetAccessKeyInfoResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.get_access_key_info)
    ...
    def get_caller_identity(self) -> GetCallerIdentityResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.get_caller_identity)
    ...
    def get_federation_token(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.get_federation_token)
    ...
    def get_session_token(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/sts.html#STS.Client.get_session_token)
