...
class PreProcessing:
    ...
    def create_trainers(self):
        if self.class_problem == 'binary' or self.class_problem == 'multiclass':
            ...
            model_2 = lgb.LGBMClassifier(random_state=self.preprocess_decisions["random_state_counter"], n_jobs=-2)
        else:
            # model_1 = VWRegressor()
            model_2 = lgb.LGBMRegressor(random_state=self.preprocess_decisions["random_state_counter"],  n_jobs=-2)
        return model_2
