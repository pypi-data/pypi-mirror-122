...
def dump_ast(node: typ.Any, annotate_fields: bool=True, include_attributes:
    bool=False, indent: str='  ') ->str:
...
def transpile_and_dump(ctx: common.BuildContext, module_str: str) ->typ.Tuple[
    str, str, str]:
...
def has_base_class(cls_node: ast.ClassDef, module_name: str=None,
    base_class_name: str=None) ->bool:
