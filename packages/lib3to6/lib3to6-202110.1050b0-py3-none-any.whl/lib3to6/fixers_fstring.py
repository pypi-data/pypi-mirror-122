...
class FStringToStrFormatFixer(fb.TransformerFixerBase):
    ...
    def _formatted_value_str(self, fmt_val_node: ast.FormattedValue,
        arg_nodes: typ.List[ast.expr]) ->str:
    ...
    def _joined_str_str(self, joined_str_node: ast.JoinedStr, arg_nodes:
        typ.List[ast.expr]) ->str:
        fmt_str = ''
