...
class LexRuntimeServiceClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.53/reference/services/lex-runtime.html#LexRuntimeService.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.53/reference/services/lex-runtime.html#LexRuntimeService.Client.can_paginate)
    ...
    def delete_session(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.53/reference/services/lex-runtime.html#LexRuntimeService.Client.delete_session)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.53/reference/services/lex-runtime.html#LexRuntimeService.Client.generate_presigned_url)
    ...
    def get_session(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.53/reference/services/lex-runtime.html#LexRuntimeService.Client.get_session)
    ...
    def post_content(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.53/reference/services/lex-runtime.html#LexRuntimeService.Client.post_content)
    ...
    def post_text(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.53/reference/services/lex-runtime.html#LexRuntimeService.Client.post_text)
    ...
    def put_session(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.53/reference/services/lex-runtime.html#LexRuntimeService.Client.put_session)
