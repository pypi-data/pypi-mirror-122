...
namespace slxpy::env::spec {
    ...
    need_render={},
    kwargs={}
))--", id, reward_threshold, max_episode_steps, IndexingModeNames[static_cast<uint8_t>(indexing_mode)], nondeterministic, auto_reset, strict_reset, need_render, std::string(pybind11::repr(kwargs)));
        }
    };
    ...
    void slxpy_bind_spec(::pybind11::module_& s) {
        ...
        EnvSpec_PB
            .def(pybind11::init([] (
                ...
                "id"_a, "reward_threshold"_a=std::nullopt, "max_episode_steps"_a=std::nullopt, "indexing_mode"_a=IndexingMode::PRESERVE_EMPTY,
