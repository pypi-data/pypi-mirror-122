...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '4.3.0-alpha.1633346827+888550ec'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 4.3.0-alpha.1633346827+888550ec`
                """)
            else:
                raise
