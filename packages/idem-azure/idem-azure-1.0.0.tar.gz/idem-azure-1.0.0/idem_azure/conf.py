...
# In this dictionary goes all the immutable values you want to show up under hub.OPT.idem_azure
CONFIG = {
    "config": {
        "default": None,
        "help": "Load extra options from a configuration file onto hub.OPT.idem_azure",
    }
}
