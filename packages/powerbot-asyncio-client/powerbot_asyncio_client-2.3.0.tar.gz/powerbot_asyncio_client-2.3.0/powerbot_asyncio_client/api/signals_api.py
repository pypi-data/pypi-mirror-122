...
class SignalsApi(object):
    ...
    def get_signals(self, **kwargs):  # noqa: E501
        ...
        Allows you to retrieve signals you have previously sent to the system. This method is mainly used for debugging purposes, as signals are usually delivered to algorithms and dashboards as a part of the orderbook request.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
