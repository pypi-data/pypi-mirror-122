...
from .downloads import get_provider_services, CONFIG_HOME, expand_path, default_repo_url
from .profiles import load_profiles
from .passgen import predef_alphabet, SecretGen, PassGen
from .updatecheck import check_download_version, do_pip_install
...
def on_check_new_version():
    ...
    rc = check_download_version(default_repo_url, VERSION, git_opts, callb=log_append)
...
def mv_setting(src2cfg=True):
    ...
    if src2cfg == True:
        ...
        print("using python_bin:", python_bin)
        downloads_version = cfg.setdefault("downloads_version", None)
        print("using downloads_version:", downloads_version)
