...
class ImportExportClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Client.can_paginate)
    ...
    def cancel_job(self, *, JobId: str, APIVersion: str = ...) -> CancelJobOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Client.cancel_job)
    ...
    def create_job(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Client.create_job)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Client.generate_presigned_url)
    ...
    def get_shipping_label(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Client.get_shipping_label)
    ...
    def get_status(self, *, JobId: str, APIVersion: str = ...) -> GetStatusOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Client.get_status)
    ...
    def list_jobs(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Client.list_jobs)
    ...
    def update_job(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Client.update_job)
    ...
    def get_paginator(self, operation_name: Literal["list_jobs"]) -> ListJobsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/importexport.html#ImportExport.Paginator.ListJobs)
