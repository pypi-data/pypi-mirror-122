...
class Project(Table, Base):
    ...
    station_obj = relationship(
        "Station", back_populates="project_obj", lazy="subquery", secondary="section",
        viewonly=True)
...
class Section(Table, Base):
    ...
    project_obj = relationship(
        "Project", back_populates="section_obj", lazy=True)
    station_obj = relationship(
    ...
    damage_obj = relationship(
        "Damage", lazy=True, secondary="station", viewonly=True)
    repair_obj = relationship(
        "Repair", lazy=True, secondary="station", viewonly=True)
    ...
    pore_pressure_sensor_position_obj = relationship(
        "PorePressureSensorPosition", back_populates="section_obj", lazy=True, viewonly=True)
    temperature_sensor_position_obj = relationship(
        "TemperatureSensorPosition", back_populates="section_obj", lazy=True, viewonly=True)
...
class Station(Table, Base):
    ...
    # Relationships:
    project_obj = relationship(
        "Project", back_populates="station_obj", lazy=True, secondary="section", viewonly=True)
    section_obj = relationship(
        "Section", back_populates="station_obj", lazy=True)

    basecourse_obj = relationship(
        "Basecourse", back_populates="station_obj", lazy=True, secondary="section", viewonly=True)
    subbase_obj = relationship(
        "Subbase", back_populates="station_obj", lazy=True, secondary="section", viewonly=True)
    subgrade_obj = relationship(
        "Subgrade", back_populates="station_obj", lazy=True, secondary="section", viewonly=True)
    surface_obj = relationship(
        "Surface", back_populates="station_obj", lazy=True, secondary="section", viewonly=True)
    damage_obj = relationship(
...
class LapCount(Table, Base):
    ...
    # Relationships:
    project_obj = relationship(
        "Project", back_populates="lap_count_obj", lazy=True)
...
class Interval(Table, Base):
    ...
    # Relationships:
    project_obj = relationship(
        "Project", back_populates="interval_obj", lazy=True)
    ...
    surface_profiler_session_obj = relationship(
        "SurfaceProfilerSession", back_populates="interval_obj", lazy=True, viewonly=True)
