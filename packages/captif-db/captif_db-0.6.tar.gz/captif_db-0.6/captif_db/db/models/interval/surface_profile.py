...
class SurfaceProfilerType(Table, Base):
    ...
    surface_profiler_obj = relationship(
        "SurfaceProfiler", back_populates="surface_profiler_type_obj", lazy=True, viewonly=True)
...
class SurfaceProfiler(Table, Base):
    ...
    surface_profiler_version_obj = relationship(
        "SurfaceProfilerVersion", back_populates="surface_profiler_obj", lazy=True, viewonly=True)
    session_obj = relationship(
        "SurfaceProfilerSession", lazy=True, secondary="surface_profiler_version", viewonly=True)
...
class SurfaceProfilerVersion(Table, Base):
    ...
    session_obj = relationship(
        "SurfaceProfilerSession", back_populates="surface_profiler_version_obj", lazy=True,
        viewonly=True,
    )
...
class SurfaceProfilerSession(Table, Base):
    ...
    surface_profiler_obj = relationship(
        "SurfaceProfiler", lazy=True, secondary="surface_profiler_version", uselist=False,
        viewonly=True
    )
    surface_profiler_version_obj = relationship(
...
class SurfaceProfilerReading(Table, Base):
    ...
    station_obj = relationship(
        "Station", back_populates="surface_profiler_reading_obj", lazy=True, viewonly=True)
    session_obj = relationship(
