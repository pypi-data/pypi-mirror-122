...
class TensorToVectorBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.dataproc.tensor.TensorToVectorBatchOp'
    OP_TYPE = 'FUNCTION'
...
class TensorToVectorStreamOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.stream.dataproc.tensor.TensorToVectorStreamOp'
    OP_TYPE = 'FUNCTION'
