set(PACKAGE_VERSION "6.2.2105-46-g85de4615e")
...
set(NGSOLVE_MKL_LIBRARIES "/tmp/pip-build-env-oyn3lhe8/overlay/lib/libmkl_rt.so.1")
set(NGSOLVE_PYBIND_INCLUDE_DIR "")
set(NGSOLVE_PYTHON_INCLUDE_DIRS "/opt/_internal/cpython-3.9.7/include/python3.9")
...
set(NGSOLVE_LINK_FLAGS " -L/tmp/pip-build-env-oyn3lhe8/overlay/lib -lmkl_rt -L$NGSCXX_DIR/../lib/python3.9/site-packages/netgen_avx2.libs -Wl,--rpath=$NGSCXX_DIR/../lib/python3.9/site-packages/netgen_avx2.libs" CACHE STRING "Link flags set in ngsld")
set(NGSOLVE_INCLUDE_DIRS /tmp/pip-build-env-oyn3lhe8/overlay/include;/opt/_internal/cpython-3.9.7/include/python3.9 CACHE STRING "Include dirs set in ngscxx")

set(NGSOLVE_INSTALL_DIR_PYTHON  lib/python3.9/site-packages)
set(NGSOLVE_INSTALL_DIR_BIN     bin)
set(NGSOLVE_INSTALL_DIR_LIB     lib/python3.9/site-packages/netgen_avx2.libs)
