...
set_target_properties(ngstd PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngstd.so"
  IMPORTED_SONAME_RELEASE "libngstd.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ngstd )
list(APPEND _IMPORT_CHECK_FILES_FOR_ngstd "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngstd.so" )
...
set_target_properties(ngbla PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngbla.so"
  IMPORTED_SONAME_RELEASE "libngbla.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ngbla )
list(APPEND _IMPORT_CHECK_FILES_FOR_ngbla "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngbla.so" )
...
set_target_properties(ngla PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngla.so"
  IMPORTED_SONAME_RELEASE "libngla.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ngla )
list(APPEND _IMPORT_CHECK_FILES_FOR_ngla "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngla.so" )
...
set_target_properties(ngfem PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngfem.so"
  IMPORTED_SONAME_RELEASE "libngfem.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ngfem )
list(APPEND _IMPORT_CHECK_FILES_FOR_ngfem "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngfem.so" )
...
set_target_properties(ngcomp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngcomp.so"
  IMPORTED_SONAME_RELEASE "libngcomp.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ngcomp )
list(APPEND _IMPORT_CHECK_FILES_FOR_ngcomp "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngcomp.so" )
...
set_target_properties(solve PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libsolve.so"
  IMPORTED_SONAME_RELEASE "libsolve.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS solve )
list(APPEND _IMPORT_CHECK_FILES_FOR_solve "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libsolve.so" )
...
set_target_properties(ngsolve PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngsolve.so"
  IMPORTED_SONAME_RELEASE "libngsolve.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS ngsolve )
list(APPEND _IMPORT_CHECK_FILES_FOR_ngsolve "${_IMPORT_PREFIX}/lib/python3.9/site-packages/netgen_avx2.libs/libngsolve.so" )
