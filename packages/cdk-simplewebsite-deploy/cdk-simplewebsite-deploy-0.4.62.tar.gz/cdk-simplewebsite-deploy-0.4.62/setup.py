    ...
    """
{
    ...
    "package_data": {
        "cdk_simplewebsite_deploy._jsii": [
            "cdk-simplewebsite-deploy@0.4.62.jsii.tgz"
        ],
        "cdk_simplewebsite_deploy": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-certificatemanager>=1.126.0, <2.0.0",
        "aws-cdk.aws-cloudfront-origins>=1.126.0, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.126.0, <2.0.0",
        "aws-cdk.aws-route53-targets>=1.126.0, <2.0.0",
        "aws-cdk.aws-route53>=1.126.0, <2.0.0",
        "aws-cdk.aws-s3-deployment>=1.126.0, <2.0.0",
