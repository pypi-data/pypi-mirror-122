...
class Binomial(Distribution):
    ...
    def replace_stats_with_data(self):
        ...
        """
        #self.data = read_data_file(file_name)
    ...
    def pdf(self,k):
        ...
        Args:
            ...
            f=n!/k!(n-k(!))p^k(1-p)^(N-K)
        
        Returns:
            float: probability density function output
        """
        f=math.factorial(self.n) / (math.factorial(k) * (math.factorial(self.n - k)))
        f=f*(self.p ** k) * (1 - self.p) ** (self.n - k)
        return f
    ...
    def __add__(self,other):   
        ...
        other.calculate_mean()
        other.calculate_stdev()
