...
class EBSClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/ebs.html#EBS.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/ebs.html#EBS.Client.can_paginate)
    ...
    def complete_snapshot(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/ebs.html#EBS.Client.complete_snapshot)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/ebs.html#EBS.Client.generate_presigned_url)
    ...
    def get_snapshot_block(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/ebs.html#EBS.Client.get_snapshot_block)
    ...
    def list_changed_blocks(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/ebs.html#EBS.Client.list_changed_blocks)
    ...
    def list_snapshot_blocks(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/ebs.html#EBS.Client.list_snapshot_blocks)
    ...
    def put_snapshot_block(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/ebs.html#EBS.Client.put_snapshot_block)
    ...
    def start_snapshot(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/ebs.html#EBS.Client.start_snapshot)
