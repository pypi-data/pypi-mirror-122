...
class ThermalCamerasApi(object):
    ...
    def get_thermal_camera_regions(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Active` | Boolean | `eq, neq` | | `LocationAbbreviation` | String | `eq, neq, like, in` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, like, in` | | `Name` | String | `eq, neq, like, in` | | `ThermalCameraSerialNumber` | Int64 | `eq, neq, in, lt, gt, leq, geq` |
    ...
    def get_thermal_cameras(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Active` | Boolean | `eq, neq` | | `Created` | DateTime | `eq, neq, in, lt, gt, leq, geq` | | `LocationAbbreviation` | String | `eq, neq, like, in` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, like, in` | | `Updated` | DateTime | `eq, neq, in, lt, gt, leq, geq` |
        :param int page: Results page. 1-based (1 returns the first page, 0 is invalid).
        :param int page_limit: Number of items to return per page.
    ...
    def update_thermal_camera(self, thermal_camera_serial_number, **kwargs):  # noqa: E501
        ...
        Updating a ThermalCamera is location admin only.  Updating a ThermalCamera Location is SaaS/Sentry only.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
