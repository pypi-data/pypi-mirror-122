...
class UsersApi(object):
    ...
    def create_user(self, **kwargs):  # noqa: E501
        ...
        Required Permissions:  - Saas can create any type of user  - Sentry can create sentry and below  - Corporation admins can create corporation admins and below  - Location admins can create location admins and below  - Users without admin rights cannot create users  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_users(self, **kwargs):  # noqa: E501
        ...
        - Saas and Sentry can get any user  - Corporation admins can get other corporation admins and users in their corporation as    well as location admins and users in the locations under their corporation  - Corporation users can get other corporation users in their corporation  - Location admins can get other location admins and location users in their location  - Location users can get other location users in their location  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_user(self, user_id, **kwargs):  # noqa: E501
        ...
        Required Permissions:  - Saas can update any type of user  - Sentry can update sentry and below  - Corporation admins can update corporation admins and below  - Location admins can update location admins and below  - Users without admin rights cannot update users  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
