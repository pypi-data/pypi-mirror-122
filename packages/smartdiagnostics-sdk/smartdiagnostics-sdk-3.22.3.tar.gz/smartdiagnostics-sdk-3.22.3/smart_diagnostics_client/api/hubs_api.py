...
class HubsApi(object):
    ...
    def get_hubs(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param bool include_online_status:
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `CorporationAbbreviation` | String | `eq, neq, like, in` | | `CorporationId` | Guid | `eq, neq, in` | | `CorporationName` | String | `eq, neq, like, in` | | `Created` | DateTime | `eq, neq, in, lt, gt, leq, geq` | | `FirmwareVersion` | String | `eq, neq, like, in` | | `HubTypeId` | HubType? | `eq, neq, in` | | `Id` | Int64 | `eq, neq, in, lt, gt, leq, geq` | | `LocationAbbreviation` | String | `eq, neq, like, in` | | `LocationId` | Guid | `eq, neq, in` | | `LocationName` | String | `eq, neq, like, in` | | `Nickname` | String | `eq, neq, like, in` | | `PowerTypeId` | HubPowerType? | `eq, neq, in` | | `ReceiverFirmwareVersion` | String | `eq, neq, like, in` | | `ReceiverId` | Int64 | `eq, neq, in, lt, gt, leq, geq` | | `ReceiverName` | String | `eq, neq, like, in` | | `ReceiverNetworkId` | String | `eq, neq, like, in` | | `ReceiverPendingRfChannel` | Int32? | `eq, neq, in, lt, gt, leq, geq` | | `ReceiverRfChannel` | Int32? | `eq, neq, in, lt, gt, leq, geq` | | `ReceiverSerialNumber` | String | `eq, neq, like, in` | | `SerialNumber` | String | `eq, neq, like, in` | | `Updated` | DateTime | `eq, neq, in, lt, gt, leq, geq` |
        ...
        :param str order_by: Allows sorting response items by multiple fields. Sortable properties: | Field name | Type | | ---------- | ---- | | `CorporationName` | String | | `Created` | DateTime | | `FirmwareVersion` | String | | `HubTypeId` | HubType? | | `LocationName` | String | | `Nickname` | String | | `PowerTypeId` | HubPowerType? | | `ReceiverFirmwareVersion` | String | | `ReceiverName` | String | | `ReceiverNetworkId` | String | | `ReceiverPendingRfChannel` | Int32? | | `ReceiverRfChannel` | Int32? | | `SerialNumber` | String | | `Updated` | DateTime |
