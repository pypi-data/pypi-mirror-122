...
class PropertiesApi(object):
    ...
    def get_properties(self, **kwargs):  # noqa: E501
        ...
        :param str filter: Filter statements to narrow results by properties. Filterable properties:  | Field name | Type | Operators | | ---------- | ---- | --------- | | `Name` | String | `eq, neq, like, in` | | `ValueType` | String | `eq, neq, like, in` |
