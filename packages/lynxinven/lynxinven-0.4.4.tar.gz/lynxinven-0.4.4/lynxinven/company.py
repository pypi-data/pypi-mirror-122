...
import lynxinven.order


logger = logging.getLogger('lynxinven')


class Company(lynxinven.base.LynxInvenObject):
    ...
    def getPurchaseOrders(self, **kwargs):
        ...
        """
        return lynxinven.order.PurchaseOrder.list(self._api, supplier=self.pk)
    ...
    def createPurchaseOrder(self, **kwargs):
        ...
        return lynxinven.order.PurchaseOrder.create(
            self._api,
            data=kwargs
        )
    ...
    def getSalesOrders(self, **kwargs):
        ...
        """
        return lynxinven.order.SalesOrder.list(self._api, customer=self.pk)
    ...
    def createSalesOrder(self, **kwargs):
        ...
        return lynxinven.order.SalesOrder.create(
            self._api,
            data=kwargs
        )
...
class SupplierPart(lynxinven.base.LynxInvenObject):
...
class ManufacturerPart(lynxinven.base.LynxInvenObject):
    """
...
class ManufacturerPartParameter(lynxinven.base.LynxInvenObject):
    """
...
class SupplierPriceBreak(lynxinven.base.LynxInvenObject):
