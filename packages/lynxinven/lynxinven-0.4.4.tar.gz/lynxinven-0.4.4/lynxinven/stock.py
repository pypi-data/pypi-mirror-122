...
import lynxinven.part


class StockLocation(lynxinven.base.LynxInvenObject):
...
class StockItem(lynxinven.base.LynxInvenObject):
    ...
    def getPart(self):
        ...
        return lynxinven.part.Part(self._api, self.part)
...
class StockItemAttachment(lynxinven.base.Attachment):
    """ Class representing a file attachment for a StockItem """

    URL = 'stock/attachment'


class StockItemTracking(lynxinven.base.LynxInvenObject):
    """ Class representing a StockItem tracking object """

    URL = 'stock/track'


class StockItemTestResult(lynxinven.base.LynxInvenObject):
    """ Class representing a StockItemTestResult object """

    URL = 'stock/test'

    def getTestKey(self):
        return lynxinven.part.PartTestTemplate.generateTestKey(self.test)
