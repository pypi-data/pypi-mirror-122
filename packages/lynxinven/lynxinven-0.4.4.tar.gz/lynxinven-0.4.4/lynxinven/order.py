...
class PurchaseOrder(lynxinven.base.LynxInvenObject):
...
class PurchaseOrderLineItem(lynxinven.base.LynxInvenObject):
    ...
    def getSupplierPart(self):
        ...
        """
        return lynxinven.company.SupplierPart(self._api, self.part)

    def getPart(self):
        """
        Return the Part referenced by the associated SupplierPart
        """
        return lynxinven.part.Part(self._api, self.getSupplierPart().part)
...
class SalesOrder(lynxinven.base.LynxInvenObject):
...
class SalesOrderLineItem(lynxinven.base.LynxInvenObject):
