...
import lynxinven.base
import lynxinven.stock
import lynxinven.company
import lynxinven.build


logger = logging.getLogger('lynxinven')


class PartCategory(lynxinven.base.LynxInvenObject):
...
class Part(lynxinven.base.LynxInvenObject):
    ...
    def getSupplierParts(self):
        ...
        return lynxinven.company.SupplierPart.list(self._api, part=self.pk)
    ...
    def getBuilds(self, **kwargs):
        ...
        return lynxinven.build.Build.list(self._api, part=self.pk, **kwargs)

    def getStockItems(self):
        """ Return the stock items associated with this part """
        return lynxinven.stock.StockItem.list(self._api, part=self.pk)
    ...
    def getParameters(self):
        ...
        return lynxinven.base.Parameter.list(self._api, part=self.pk)
...
class PartAttachment(lynxinven.base.Attachment):
    ...
    def upload_attachment(cls, api, part, **kwargs):
        ...
        args:
            api: Authenticated LynxInven API object
...
class PartTestTemplate(lynxinven.base.LynxInvenObject):
...
class BomItem(lynxinven.base.LynxInvenObject):
