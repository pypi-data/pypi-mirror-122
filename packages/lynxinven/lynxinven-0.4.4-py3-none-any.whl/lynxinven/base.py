...
LYNXINVEN_PYTHON_VERSION = "0.4.4"


logger = logging.getLogger('lynxinven')


class LynxInvenObject(object):
    """ Base class for an LynxInven object """
    ...
    def __init__(self, api, pk=None, data={}):
        """ Instantiate this LynxInven object.
...
class Attachment(LynxInvenObject):
...
class Currency(LynxInvenObject):
    """ Class representing the Currency database model """

    URL = 'common/currency'


class Parameter(LynxInvenObject):
...
class ParameterTemplate(LynxInvenObject):
