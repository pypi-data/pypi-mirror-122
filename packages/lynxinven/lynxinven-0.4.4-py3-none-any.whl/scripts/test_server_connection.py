...
"""
A simple script to test connection to an LynxInven server.
...
from lynxinven.api import LynxInvenAPI
...
def test_server(address, **kwargs):
    ...
    api = LynxInvenAPI(address, **kwargs)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="LynxInven server test")

    parser.add_argument("address", help="LynxInven server address")
    ...
    print("LynxInven python version: " + LYNXINVEN_PYTHON_VERSION)
