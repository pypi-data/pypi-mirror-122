...
<div id="checkboxLabel"><slot></slot></div>`;l.setAttribute("strip-whitespace",""),(0,n.k)({_template:l,is:"paper-checkbox",behaviors:[a.K],hostAttributes:{role:"checkbox","aria-checked":!1,tabindex:0},properties:{ariaActiveAttribute:{type:String,value:"aria-checked"}},attached:function(){(0,c.T8)(this,(function(){if("-1px"===this.getComputedStyleValue("--calculated-paper-checkbox-ink-size").trim()){var e=this.getComputedStyleValue("--calculated-paper-checkbox-size").trim(),t="px",r=e.match(/[A-Za-z]+$/);null!==r&&(t=r[0]);var a=parseFloat(e),o=8/3*a;"px"===t&&(o=Math.floor(o))%2!=a%2&&o++,this.updateStyles({"--paper-checkbox-ink-size":o+t})}}))},_computeCheckboxClass:function(e,t){var r="";return e&&(r+="checked "),t&&(r+="invalid"),r},_computeCheckmarkClass:function(e){return e?"":"hidden"},_createRipple:function(){return this._rippleContainer=this.$.checkboxContainer,o.S._createRipple.call(this)}})},25782:(e,t,r)=>{"use strict";r(43437),r(65660),r(47686),r(97968);var a=r(9672),o=r(50856),n=r(33760);(0,a.k)({_template:o.d`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[n.U]})},33760:(e,t,r)=>{"use strict";r.d(t,{U:()=>n});r(43437);var a=r(51644),o=r(26110);const n=[a.P,o.a,{hostAttributes:{role:"option",tabindex:"0"}}]},89194:(e,t,r)=>{"use strict";r(43437),r(65660),r(1656),r(47686);var a=r(9672),o=r(50856);(0,a.k)({_template:o.d`
    <style>
      :host {
...
//# sourceMappingURL=chunk.40ab2232a109250f6cd4.js.map