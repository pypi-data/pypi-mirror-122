...
setup(
    ...
    # Author details
    author="Neal Nie",
    author_email="guangze.nie@outlook.com",
    # Choose your license
    license="LGPLv3+",
    ...
    # package_data={"openGA": ["openGA/config/*.csv"]},
    ...
    # entry_points={"console_scripts": ["openGA = openGA.gui.openGAgui:main [gui,export,decode]"]},
)
