...
import spacetime_tree
from spacetime_tree import spacetime_tree_cython
from spacetime_tree_cython import SpaceTimeTree 

    
def get_tree_lag(df,thetacrit,nu,timeweightfn,spaceweightfn,tscale,sscale):
    '''
    get_tree_lag
    ...
    tree=SpaceTimeTree(ncells,power,pgids,times,pgid_to_longlat,longlat_to_pgid,pgid_to_index,time_to_index,index_to_time)
