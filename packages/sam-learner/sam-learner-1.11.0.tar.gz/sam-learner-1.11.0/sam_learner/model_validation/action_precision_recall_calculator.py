...
class PrecisionRecallCalculator:
	...
	def calculate_precision_recall_for_unknown_actions(self, action_name: str, num_trajectories: int) -> Dict[str, float]:
		"""
	...
	def write_learned_actions_statistics(
		...
		for not_learned_action in not_yet_learned_action_names:
			learned_actions_statistics.append(
				self.calculate_precision_recall_for_unknown_actions(not_learned_action, num_trajectories))
