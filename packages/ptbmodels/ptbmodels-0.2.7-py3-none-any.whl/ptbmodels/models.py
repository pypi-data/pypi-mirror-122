...
from sqlmodel import Column, Field, Index, JSON, Relationship, String, SQLModel
...
Index("ix_article_title", Article.summary, postgresql_using="gin")
Index("ix_article_summary", Article.summary, postgresql_using="gin")
Index("ix_article_authors", Article.summary, postgresql_using="gin")
...
Index("ix_rawcontent_content", RawContent.content, postgresql_using="gin")
...
Index("ix_parsedcontent_content", ParsedContent.content, postgresql_using="gin")
...
Index("ix_termcount_term", TermCount.term, postgresql_using="gin")
