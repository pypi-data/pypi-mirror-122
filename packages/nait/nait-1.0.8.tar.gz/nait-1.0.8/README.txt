...
--------------------
    ...
    To train a network:
        ...
        Training model setup:
            ...
            You dont need to have multiple inputs, but you need to put the inputs in a list. (example: [[1.0, 1.0, 1.0, 1.0]])
            To use multiple inputs you can simple put more inputs in that list. (example: [[1.0, 1.0, 1.0, 1.0], [2.0, 2.0, 2.0, 2.0]])
            You now need a set of what output you would want for each of those inputs.
            This list is formatted the same way as the inputs but can still have a different number of values. (example: [[10.0, 10.0], [20.0, 20.0]])
