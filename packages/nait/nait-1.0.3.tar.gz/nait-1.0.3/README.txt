...
NAIT is a for super easily training and using a neural network.
...
To use NAIT:
    ...
    To train a network:
        ...
        Actual training:
            ...
            You define how long it trains for in epochs which is 2500 generations each.
    ...
    To use a network:
        ...
        Inputs:
            ...
            You can also give it multiple input lists at the same time. (exaple: [[1.0, 1.0, 1.0, 1.0], [2.0, 2.0, 2.0, 2.0]])
            It will then return a output of as many values as it was trained on. (exaple: [[10.0, 10.0], [20.0, 20.0]])