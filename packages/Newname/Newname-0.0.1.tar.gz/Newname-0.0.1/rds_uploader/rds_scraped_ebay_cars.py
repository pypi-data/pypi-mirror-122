...
class DataHandling:
    ...
    def __init__(self):
        ...
        self.DBAPI = 'psycopg2'
        self.HOST = '[18.132.161.210]'  #input('Enter your host address: ')  # 'aicoredb.cjpo05djrpn0.eu-west-2.rds.amazonaws.com' '[18.132.161.210]'
        self.USER = input('Enter your user: ')  # postgres
        self.PASSWORD = input('Enter your password: ') # 'Orebach94*'
        self.PORT = 5432
