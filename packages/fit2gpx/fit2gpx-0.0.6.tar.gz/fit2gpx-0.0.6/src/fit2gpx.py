"""Classes to convert FIT files (from Garmin) to GPX files, and to fix Strava Bulk Export data format issues
"""
import os
import gzip
import shutil
...
class StravaConverter(Converter):
    """Converter to use when converting .FIT files from Strava Bulk Export to GPX files"""
