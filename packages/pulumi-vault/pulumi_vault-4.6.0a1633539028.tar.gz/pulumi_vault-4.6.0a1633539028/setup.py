...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '4.6.0-alpha.1633539028+06826981'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 4.6.0-alpha.1633539028+06826981`
                """)
            else:
                raise
