...
from datarobot_bp_workshop.task import Task
...
class TaskFactory(object):
    ...
    def __call__(self, task_definition: UserBlueprintTaskDefinition):
        ...
        if task_definition.custom_task_id:
            ...
            class Versions(FriendlyRepr):
                ...
                def __init__(zelf):
                    for version in task_definition.custom_task_versions:
                        setattr(zelf, version.label.replace(".", "_"), version.id)
            ...
            tasks_class_attributes["versions"] = Versions()
