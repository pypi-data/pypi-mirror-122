...
setup(
    name='celebrity_births_test34324253252', ## This will be the name your package will be published with
    version='0.0.1', 
    description='Mock package that allows you to find celebrity by date of birth',
    url='https://github.com/BlairMar/Celebs-births.git', # Add the URL of your github repo if published 
                                                                   # in GitHub
