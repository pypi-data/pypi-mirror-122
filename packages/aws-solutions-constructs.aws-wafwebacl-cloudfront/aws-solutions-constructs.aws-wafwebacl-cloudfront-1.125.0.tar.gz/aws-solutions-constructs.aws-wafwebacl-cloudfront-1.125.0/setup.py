    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_wafwebacl_cloudfront._jsii": [
            "aws-wafwebacl-cloudfront@1.125.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_wafwebacl_cloudfront": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-constructs.aws-cloudfront-apigateway-lambda==1.125.0",
        "aws-solutions-constructs.aws-cloudfront-mediastore==1.125.0",
