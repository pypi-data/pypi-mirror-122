...
class OptimizeThreshold(object):
    ...
    def __init__(self, Starmodel, Unetmodel, X, Y, basedir, UseProbability = True, n_tiles = (4,4), min_size = 20, nms_threshs=[0,0.05,0.1,0.15,0.2,0.3,0.4], iou_threshs=[0.6, 0.65, 0.68], measure='accuracy', axis = 'ZYX', axis_norm = (0,1,2)):
    ...
    def Optimize(self):
        ...
        self.X = [normalize(x,1,99.8,axis= self.axis_norm) for x in tqdm(self.X)]
