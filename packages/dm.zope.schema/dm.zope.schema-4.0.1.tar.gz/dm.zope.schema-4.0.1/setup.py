...
try:
  ...
  setupArgs = dict(
      ...
      install_requires=['zope.schema>=4', "dm.reuse>=2.1.1", "decorator", "six"],
      namespace_packages=['dm', 'dm.zope'],
      zip_safe=False,
      test_suite='dm.zope.schema.tests.test_suite',
      test_requires=['zope.schema>=4'],
      )
except ImportError:
  # use distutils
...
#        'Development Status :: 3 - Alpha',
      ...
      url='https://pypi.org/project/dm.zope.schema',
