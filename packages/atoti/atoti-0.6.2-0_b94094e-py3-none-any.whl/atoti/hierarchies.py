...
class Hierarchies(LocalHierarchies[Hierarchy]):
    ...
    def update(  # type: ignore
        ...
        hierarchies: Union[
            Mapping[
                _HierarchyKey,
                Union[Sequence[LevelOrColumn], Mapping[str, LevelOrColumn]],
            ],
            Iterable[
                Tuple[
                    _HierarchyKey,
        ...
        **kwargs: Union[Sequence[LevelOrColumn], Mapping[str, LevelOrColumn]],
    ):
...
def _normalize_levels(
    levels_or_columns: Union[Sequence[LevelOrColumn], Mapping[str, LevelOrColumn]]
) -> Mapping[str, LevelOrColumn]:
    if isinstance(levels_or_columns, Sequence):
        return {
            level_or_column.name: level_or_column
            for level_or_column in levels_or_columns
        }
    return levels_or_columns
