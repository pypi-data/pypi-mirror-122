...
_QUERY_ARGS_WITH_MODE_DOC = f"""{_get_query_args_doc(is_query_session=False)}
            mode: The query mode.
...
class LocalCube(BaseCube[_LocalHierarchies, _Levels, _LocalMeasures]):
    ...
    def query(
        ...
        *measures: _Measure,
        ...
        levels: Optional[Sequence[_Level]] = None,
    ...
    @doc(_EXPLAIN_QUERY_DOC, corresponding_method="query")
    def explain_query(
        self,
        *measures: _Measure,
        condition: Optional[
