...
class LexRuntimeV2Client(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/lexv2-runtime.html#LexRuntimeV2.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/lexv2-runtime.html#LexRuntimeV2.Client.can_paginate)
    ...
    def delete_session(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/lexv2-runtime.html#LexRuntimeV2.Client.delete_session)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/lexv2-runtime.html#LexRuntimeV2.Client.generate_presigned_url)
    ...
    def get_session(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/lexv2-runtime.html#LexRuntimeV2.Client.get_session)
    ...
    def put_session(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/lexv2-runtime.html#LexRuntimeV2.Client.put_session)
    ...
    def recognize_text(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/lexv2-runtime.html#LexRuntimeV2.Client.recognize_text)
    ...
    def recognize_utterance(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/lexv2-runtime.html#LexRuntimeV2.Client.recognize_utterance)
