...
class DbtMacro:
    ...
    def from_dict(obj: Any) -> 'DbtMacro':
        assert isinstance(obj, dict)
        arguments = from_union([lambda x: from_list(from_str, x), from_none], obj.get("arguments"))
    ...
    def to_dict(self) -> dict:
        result: dict = {}
        result["arguments"] = from_union([lambda x: from_list(from_str, x), from_none], self.arguments)
