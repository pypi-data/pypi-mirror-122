...
from tfx.proto import yulong_pusher_pb2
...
_Versioning = yulong_pusher_pb2.Versioning
...
class Executor(base_executor.BaseExecutor):
  ...
  def Do(self, input_dict: Dict[Text, List[types.Artifact]],
    ...
    # Set up InferenceService spec.executor_class

    # If the model didn't be blessed, 

    logging.info("***************** Yulong 20211008 rflow-tfx v1.2.2 YulongPusher start.")
    print("***************** Yulong 20211008 rflow-tfx v1.2.2 YulongPusher start.")

    push_destination = yulong_pusher_pb2.PushDestination()
...
#                           spec=V1beta1InferenceServiceSpec(predictor=predictor_create))
    ...
    if not self.CheckBlessing(input_dict):
      ...
      print("Current model didn't be blessed")
      ...
      try:
        ...
        print("Error info about No existing InferenceService: ", error)
        logging.info("Error info about No existing InferenceService: ", error)
        ############## Yulong 20211008 end ##############
      return None
    ...
    logging.info("***************** Yulong 20211008 YulongPusher end.")
    print("***************** Yulong 20211008 YulongPusher end.")
    ############## Yulong 20211008 end ##############
