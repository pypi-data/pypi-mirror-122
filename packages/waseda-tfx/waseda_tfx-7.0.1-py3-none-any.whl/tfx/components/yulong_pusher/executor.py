...
class Executor(base_executor.BaseExecutor):
  ...
  def Do(self, input_dict: Dict[Text, List[types.Artifact]],
    ...
    logging.info("***************** Yulong 20211007 v1.1.2 start.")
    print("***************** Yulong 20211007 v1.1.2 start.")
...
#                           spec=V1beta1InferenceServiceSpec(predictor=predictor_create))
    ...
    ############## Yulong 20211007 start ##############
    logging.info('InferenceService code start.')
    try:
    ...
    logging.info('InferenceService code end.')
    logging.info("***************** Yulong 20211007 end.")
    print("***************** Yulong 20211007 end.")
    ############## Yulong 20211007 end ##############
