...
class CreditControlAnswer(DiameterAnswer):
    ...
    Usage::
        ...
        >>> cca = CCA()
        >>> cca
        <Diameter Message: 272 [CCA] PXY, 16777238 [3GPP Gx], ? AVP(s)>    
    """
...
class CreditControlRequest(DiameterRequest):
    ...
    Usage::
        ...
        >>> ccr = CCR(**ccr_avps)
        >>> ccr
        <Diameter Message: 272 [CCR] REQ|PXY, 16777238 [3GPP Gx], ? AVP(s)>
    """
...
class ReAuthAnswer(DiameterAnswer):
    ...
    Usage::
        ...
        >>> raa = RAA()
        >>> raa
        <Diameter Message: 258 [RAA] PXY, ???? [3GPP Gx], ? AVP(s)>    
    """
...
class ReAuthRequest(DiameterRequest):
    ...
    Usage::
        ...
        >>> rar = CCR(**rar_avps)
        >>> rar
        <Diameter Message: 258 [RAR] REQ|PXY, ???? [3GPP Gx], ? AVP(s)>
    """
