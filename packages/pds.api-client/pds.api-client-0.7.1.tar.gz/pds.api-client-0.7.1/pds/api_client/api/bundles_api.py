...
class BundlesApi(object):
    ...
    def bundle_by_lidvid_all(self, lidvid, **kwargs):  # noqa: E501
        """Get one bundle by lidvid, or all versions of a bundle by lid  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.bundle_by_lidvid_all(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.bundle_by_lidvid_all_with_http_info(lidvid, **kwargs)  # noqa: E501

    def bundle_by_lidvid_all_with_http_info(self, lidvid, **kwargs):  # noqa: E501
        """Get one bundle by lidvid, or all versions of a bundle by lid  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.bundle_by_lidvid_all_with_http_info(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method bundle_by_lidvid_all" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'lidvid' is set
        if self.api_client.client_side_validation and ('lidvid' not in local_var_params or  # noqa: E501
                                                        local_var_params['lidvid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `lidvid` when calling `bundle_by_lidvid_all`")  # noqa: E501
    ...
    def bundle_by_lidvid_latest(self, lidvid, **kwargs):  # noqa: E501
        """bundle URN resolver for lidvid, get one bundle  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.bundle_by_lidvid_latest(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.bundle_by_lidvid_latest_with_http_info(lidvid, **kwargs)  # noqa: E501

    def bundle_by_lidvid_latest_with_http_info(self, lidvid, **kwargs):  # noqa: E501
        """bundle URN resolver for lidvid, get one bundle  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.bundle_by_lidvid_latest_with_http_info(lidvid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method bundle_by_lidvid_latest" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'lidvid' is set
        if self.api_client.client_side_validation and ('lidvid' not in local_var_params or  # noqa: E501
                                                        local_var_params['lidvid'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `lidvid` when calling `bundle_by_lidvid_latest`")  # noqa: E501
