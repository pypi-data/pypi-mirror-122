...
class ExecutionEngine(Protocol):
    ...
    def notify_consensus_validated(self, block_hash: Hash32, valid: bool) -> None:
        ...
...
def prepare_execution_payload(state: BeaconState,
    ...
    if not is_merge_complete(state):
        terminal_pow_block = get_pow_block_at_total_difficulty(config.TERMINAL_TOTAL_DIFFICULTY, pow_chain)
