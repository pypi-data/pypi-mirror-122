...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '5.5.0-alpha.1633346814+b3550095'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 5.5.0-alpha.1633346814+b3550095`
                """)
