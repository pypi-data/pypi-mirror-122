...
class OrderApi(object):
    ...
    def get_order_by_field(self, store, **kwargs):  # noqa: E501
        ...
        :param str client_order_ref: Client order ref of third party platform. Platform API is called: Douyin.
        :param str status: Order status, available options are: WAIT_BUYER_PAY, WAIT_SELLER_SEND_GOODS, WAIT_BUYER_CONFIRM_GOODS, TRADE_SUCCESS, TRADE_CLOSED,TRADE_REFUND, TRADE_FAILED. Platform support status comma separated: Douyin, Jingdong
