...
class IdentityStoreClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/identitystore.html#IdentityStore.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/identitystore.html#IdentityStore.Client.can_paginate)
    ...
    def describe_group(self, *, IdentityStoreId: str, GroupId: str) -> DescribeGroupResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/identitystore.html#IdentityStore.Client.describe_group)
    ...
    def describe_user(self, *, IdentityStoreId: str, UserId: str) -> DescribeUserResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/identitystore.html#IdentityStore.Client.describe_user)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/identitystore.html#IdentityStore.Client.generate_presigned_url)
    ...
    def list_groups(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/identitystore.html#IdentityStore.Client.list_groups)
    ...
    def list_users(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/identitystore.html#IdentityStore.Client.list_users)
