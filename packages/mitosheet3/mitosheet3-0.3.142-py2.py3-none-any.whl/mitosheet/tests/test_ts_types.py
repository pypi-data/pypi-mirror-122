...
def test_filter_conditions_match():
    boolean_filter_conditions = get_enum_from_ts_file('./src/components/taskpanes/ControlPanel/FilterAndSortTab/filter/filterTypes.tsx', 'BooleanFilterCondition')
    ...
    number_filter_conditions = get_enum_from_ts_file('./src/components/taskpanes/ControlPanel/FilterAndSortTab/filter/filterTypes.tsx', 'NumberFilterCondition')
    ...
    string_filter_conditions = get_enum_from_ts_file('./src/components/taskpanes/ControlPanel/FilterAndSortTab/filter/filterTypes.tsx', 'StringFilterCondition')
    ...
    datetime_filter_conditions = get_enum_from_ts_file('./src/components/taskpanes/ControlPanel/FilterAndSortTab/filter/filterTypes.tsx', 'DatetimeFilterCondition')
