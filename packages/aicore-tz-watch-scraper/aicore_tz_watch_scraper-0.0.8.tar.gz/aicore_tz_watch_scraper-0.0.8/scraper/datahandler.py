...
class DataHandler():
    ...
    try:
        ...
        print("please upload database details to a json file in the scraper package located  at: ", os.path.realpath(__file__))
    ...
    def store_data_online(self, data):
        ...
        try:
            ...
            print("DB engine not connected... \nPlease enter details in a json file, which can be placed in the scraper package located at: ", os.path.realpath(__file__))
