...
class TestDrbValueNodeImage(unittest.TestCase):
    ...
    def test_value_remove_add_attributes(self):
        node = self.open_node(str(self.image_tif_one))
        ...
        with self.assertRaises(NotImplementedError):
            node_value.add_attribute("toto")
        with self.assertRaises(NotImplementedError):
            node_value.remove_attribute("toto")
    ...
    def test_variable_get_child_at(self):
        ...
        with self.assertRaises(DrbException):
            node_value.get_child_at(-2)
        with self.assertRaises(DrbException):
            node_value.get_child_at(0)
        with self.assertRaises(DrbException):
            node_value.get_named_child('Name')
    ...
    def test_variable_get_first_last_children(self):
        ...
        self.assertEqual(node_value.get_children_count(), 0)
    ...
    def test_path(self):
        ...
        node_value = root_node.get_named_child(
            DrbImageNodesValueNames.FORMAT.value, occurrence=1)
