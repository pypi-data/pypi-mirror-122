...
class WhitespaceTokenizer_omran_fr(Tokenizer):
    ...
    def tokenize_pr(self, message: Message, attribute: Text ) -> List[Token]:
        ...
        stop_words = ['vos','serais','serai','vous','pour','c','voulais','avec','l','d','les','en','j','ai','des','les','quelles','sont','quels','du','que','ce','est','je','un','une','le','la','de','avec','sur','moi','avec','des','stp','plait','les','tu','puis']
