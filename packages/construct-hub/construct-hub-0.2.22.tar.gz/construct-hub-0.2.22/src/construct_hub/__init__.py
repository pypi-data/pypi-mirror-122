...
ConstructHub(self, "ConstructHub",
    ...
    featured_packages={
        "sections": [{
            ...
            "show_packages": ["@aws-cdk/core", "@aws-cdk/s3", "@aws-cdk/lambda", "@aws-cdk/iam"
            ]
        }
        ]
    }
...
class FeaturedPackagesSection:
    def __init__(
        ...
        *,
        ...
        show_packages: typing.Optional[typing.Sequence[builtins.str]] = None,
    ) -> None:
    ...
    @builtins.property
    def show_packages(self) -> typing.Optional[typing.List[builtins.str]]:
