...
class TestDrbZip(unittest.TestCase):
    ...
    def test_has_impl(self):
        ...
        first_node = node.get_first_child()

        node_dir_xml = first_node.get_named_child("xml", occurrence=1)

        node_file_xml_1 = node_dir_xml.get_named_child("a_xml", occurrence=1)
    ...
    def test_get_impl(self):
        ...
        node_file_1 = node_dir_xml.get_named_child("a_xml", occurrence=1)
    ...
    def test_get_impl_read_line(self):
        ...
        node_dir_xml = first_node.get_named_child("xml",
                                                  occurrence=1)

        node_file_xml_1 = node_dir_xml.get_named_child("a_xml",
                                                       occurrence=1)
