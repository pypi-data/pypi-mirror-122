...
class DrbTarNode(DrbLogicalNode):
    ...
    def _get_members(self):
        return self._parent._get_members()
    ...
    def get_impl(self, impl: type) -> Any:
        if self.has_impl(impl):
            return self._parent._open_member(self._tar_info)
