...
packages = \
['koil', 'koil.checker', 'koil.checker.defaults', 'koil.config']
...
setup_kwargs = {
    'name': 'koil',
    'version': '0.1.24',
    'description': 'An abstract event loop to run in an async and sync context (especially jupyter), with utility functions to allow both accesses',
