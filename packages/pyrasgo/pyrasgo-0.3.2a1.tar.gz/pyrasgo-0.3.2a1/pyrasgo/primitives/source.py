...
if TYPE_CHECKING:
    from pyrasgo.utils.transform_chain import TransformChain
...
# --------
    ...
    def transform(self,
        ...
        transformed dataset as a df or SQL as a df with .preview() and .preview_sql()
        ...
        """
        from pyrasgo.utils import transform_chain
        ...
        transform_chain = transform_chain.TransformChain(self)
        return transform_chain.transform(
            transform_id, transform_name, transform, arguments, utilities
        )
