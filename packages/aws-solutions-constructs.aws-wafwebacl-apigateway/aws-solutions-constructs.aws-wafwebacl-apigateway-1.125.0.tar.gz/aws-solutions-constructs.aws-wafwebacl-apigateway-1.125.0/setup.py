    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_wafwebacl_apigateway._jsii": [
            "aws-wafwebacl-apigateway@1.125.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_wafwebacl_apigateway": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-constructs.aws-apigateway-dynamodb==1.125.0",
        "aws-solutions-constructs.aws-apigateway-iot==1.125.0",
        "aws-solutions-constructs.aws-apigateway-kinesisstreams==1.125.0",
        "aws-solutions-constructs.aws-apigateway-lambda==1.125.0",
        "aws-solutions-constructs.aws-apigateway-sagemakerendpoint==1.125.0",
        "aws-solutions-constructs.aws-apigateway-sqs==1.125.0",
