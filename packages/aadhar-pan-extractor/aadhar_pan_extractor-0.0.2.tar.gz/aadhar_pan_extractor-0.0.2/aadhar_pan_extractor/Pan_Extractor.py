"""
    ...
    Contact: deepaksingh0034602@gmail.com
...
class Pan_Info_Extractor:
    ...
    def info_extractor(self, image_file):
        ...
        gov = [i for i, txt in enumerate(OCR_text) if 'INDIA' in txt][0]
        ...
        for text in OCR_text:
            if self.Aadhar == 'NAN' and re.search(self.panpatn, text):
                self.Aadhar = re.search(self.panpatn, text).group()
                # print(self.PAN)
                break
