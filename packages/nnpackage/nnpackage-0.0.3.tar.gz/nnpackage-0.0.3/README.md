...
This is a wrapper on SchNetPack. Please, if you would like to use the original package go to [SchNetPack](https://github.com/atomistic-machine-learning/schnetpack)
...
```
pip install netpack # not ready yet
```
