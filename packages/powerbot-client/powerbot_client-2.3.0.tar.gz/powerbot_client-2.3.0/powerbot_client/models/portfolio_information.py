...
class PortfolioInformation(object):
    ...
    def sell_abs_pos(self):
        ...
        The expected abs_pos (see above) plus the absolute quantity of all standing SELL-Orders for the respective contract. Optional safety feature to mitigate race conditions if client and backend data are not in sync. Do not use this field for block products.  # noqa: E501
    ...
    def buy_abs_pos(self):
        ...
        The expected abs_pos (see above) plus the absolute quantity of all standing BUY-Orders for the respective contract. Optional safety feature to mitigate race conditions if client and backend data are not in sync. Do not use this field for block products.  # noqa: E501
