...
class ModelConfig:
    def __init__(self, configuration_values=None):
        ...
        if "model" in configuration_values:
            if not "backend" in configuration_values:
                configuration_values['backend']='tensorflow'
            configuration_values["model"] = get_model(configuration_values["model"], bakend=configuration_values['backend'])
