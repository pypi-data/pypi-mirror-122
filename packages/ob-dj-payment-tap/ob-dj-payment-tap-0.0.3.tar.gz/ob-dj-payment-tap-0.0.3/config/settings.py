...
LOGGING = {
    ...
    "loggers": {
        ...
        "ob_dj_payment_tap": {"handlers": ["console"]},
    },
}
...
# Django Payment Tap
# ----------------------------------------------------------------------------
# Source id (KNET - src_kw.knet, Token ID, Authorize ID, Tap Payment page -
#   src_all, Tap Card page - src_card)
TAP_PAYMENT_OPTIONS = "src_all"
TAP_KNET_REDIRECT_URI = ""
TAP_KNET_CALLBACK_URI = ""
