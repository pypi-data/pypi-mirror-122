...
class PulsarConfig(BaseSettings):
    ...
    max_workers: int = Field(default=None, description="(optional) number of concurrent workers for handling requests, "
                                                       "default: number of processors on the machine, multiplied by 5")

    queue_size: int = Field(default=None, description="(optional) size of the request queue, if MAX_WORKERS is set, "
