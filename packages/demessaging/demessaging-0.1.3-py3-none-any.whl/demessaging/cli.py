...
def get_parser(
    ...
    add("--max_workers", help=desc("max_workers"), default=conf_dict["max_workers"])

    add("--queue_size", help=desc("queue_size"), default=conf_dict["queue_size"])
    ...
    sp.set_defaults(command_params=["line_length"])
