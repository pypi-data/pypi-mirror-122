...
class PulsarMessageConsumer(PulsarConnection):
    ...
    def check_config(self):
        ...
        if self.pulsarConfig.get(PulsarConfigKeys.QUEUE_SIZE) is not None and \
           self.pulsarConfig.get(PulsarConfigKeys.MAX_WORKERS) is not None and \
           self.pulsarConfig.get(PulsarConfigKeys.QUEUE_SIZE) < self.pulsarConfig.get(PulsarConfigKeys.MAX_WORKERS):
