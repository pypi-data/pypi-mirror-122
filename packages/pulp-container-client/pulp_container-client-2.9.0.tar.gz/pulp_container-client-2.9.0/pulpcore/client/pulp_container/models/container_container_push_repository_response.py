...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, description=None, pulp_created=None, latest_version_href=None, retain_repo_versions=None, versions_href=None, pulp_labels=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
