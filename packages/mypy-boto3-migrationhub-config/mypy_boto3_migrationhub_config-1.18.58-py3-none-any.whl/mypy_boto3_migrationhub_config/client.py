...
class MigrationHubConfigClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/migrationhub-config.html#MigrationHubConfig.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/migrationhub-config.html#MigrationHubConfig.Client.can_paginate)
    ...
    def create_home_region_control(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/migrationhub-config.html#MigrationHubConfig.Client.create_home_region_control)
    ...
    def describe_home_region_controls(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/migrationhub-config.html#MigrationHubConfig.Client.describe_home_region_controls)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/migrationhub-config.html#MigrationHubConfig.Client.generate_presigned_url)
    ...
    def get_home_region(self) -> GetHomeRegionResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/migrationhub-config.html#MigrationHubConfig.Client.get_home_region)
