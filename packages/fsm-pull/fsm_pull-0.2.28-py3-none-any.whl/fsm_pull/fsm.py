...
def convert_date(date_string: str, trailing=False, timezone="Asia/Kolkata") -> str:
    ...
    current_time = current_time.replace(hour=23, minute=59, tzinfo=pytz.timezone(timezone))
    ...
    if date_string == "now":
        ...
        if trailing:
            given_date = given_date.replace(hour=23, minute=59, tzinfo=pytz.timezone(timezone))
        else:
