...
class NonrelatedStackedInline(NonrelatedBaseMixin, admin.StackedInline):
    pass


class NonrelatedTabularInline(NonrelatedBaseMixin, admin.TabularInline):
    pass
