...
class LindbladErrorgen(_LinearOperator):
    ...
    def __init__(self, lindblad_term_dict, parameterization='auto', lindblad_basis='pp',
        ...
        self.hamGens, self.otherGens, self.hamGens_1norms, self.otherGens_1norms = self._init_generators(dim)
    ...
    def to_dense(self, on_space='minimal'):
        ...
        if self._rep_type == 'lindblad errorgen':
            ...
            hamGens, otherGens, _, _ = self._init_generators(self.dim)
    ...
    def to_memoized_dict(self, mmg_memo):
        ...
        mm_dict['coefficients'] = [(str(k), self._encodevalue(v)) for k, v in self.coefficients().items()]
        return mm_dict
