...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.7.0-alpha.1633346817+9acd1cd6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.7.0-alpha.1633346817+9acd1cd6`
                """)
            else:
                raise
