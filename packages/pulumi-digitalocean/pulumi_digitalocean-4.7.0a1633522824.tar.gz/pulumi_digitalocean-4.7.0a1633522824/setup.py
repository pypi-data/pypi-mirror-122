...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.7.0-alpha.1633522824+80d0fc4b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.7.0-alpha.1633522824+80d0fc4b`
                """)
            else:
                raise
