...
class QuickbooksCore(SitesCore):
    ...
    def login_to_site(self) -> bool:
        ...
        for i in range(1, 4):
            try:
                ...
                if self.browser.does_page_contain_element('//input[@id="ius-signin-userId-input"]'):
                ...
                if self.browser.does_page_contain_element('//input[@id="ius-password"]'):
                ...
                if self.browser.does_page_contain_element('//div[text()="Let\'s make sure you\'re you"]'):
                ...
                if self.browser.does_page_contain_element('//div[@data-automation-id="cm_client_hub_business_name"]'):
    ...
    def go_to_client_page(self, client_name: str) -> None:
        ...
        :return: None
        """
        self.browser.click_element_when_visible('//span[text()="GO TO QUICKBOOKS"]')
        self.wait_element(f'//span[text()="{client_name}"]')
        self.browser.click_element_when_visible(f'//span[text()="{client_name}"]')
    ...
    def open_add_invoice_page(self) -> None:
        ...
        self.browser.click_element_when_visible('//button[@data-id="global_create_button"]')
        self.wait_element('//a[@data-id="invoice"]')
        self.browser.click_element_when_visible('//a[@data-id="invoice"]')
