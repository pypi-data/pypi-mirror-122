...
class Client(Callbacks, SocketHandler):
    ...
    def login_sid(self, SID: str):
        ...
        **Parameters**
        ...
        user_info = self.get_user_info(self.uid)
    ...
    def login(self, email: str, password: str):
        ...
        **Returns**
        ...
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
            ...
            self.uid = self.json["account"]["uid"]
    ...
    def join_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.uid}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def leave_chat(self, chatId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.uid}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
        ...
        **Returns**
        ...
        if doNotDisturb is not None:
            if doNotDisturb:
                ...
                response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.uid}/alert", data=data, headers=self.parse_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
        ...
        if backgroundImage is not None:
            ...
            response = requests.post(f"{self.api}/g/s/chat/thread/{chatId}/member/{self.uid}/background", data=data, headers=self.parse_headers(data=data), proxies=self.proxies, verify=self.certificatePath)
            if response.status_code != 200: res.append(exceptions.CheckException(json.loads(response.text)))
            else: res.append(response.status_code)
    ...
    def follow(self, userId: Union[str, list]):
        ...
        **Returns**
        ...
        if isinstance(userId, str):
            ...
            response = requests.post(f"{self.api}/g/s/user-profile/{self.uid}/joined", headers=self.parse_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
    ...
    def unfollow(self, userId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.api}/g/s/user-profile/{userId}/member/{self.uid}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def edit_profile(self, nickname: str = None, content: str = None, icon: BinaryIO = None, backgroundColor: str = None, backgroundImage: str = None, defaultBubbleId: str = None):
        ...
        **Returns**
        ...
        data = json.dumps(data)
        response = requests.post(f"{self.api}/g/s/user-profile/{self.uid}", headers=self.parse_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def reorder_linked_communities(self, comIds: list):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/user-profile/{self.uid}/linked-community/reorder", headers=self.parse_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def add_linked_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.post(f"{self.api}/g/s/user-profile/{self.uid}/linked-community/{comId}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def remove_linked_community(self, comId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino.lib.util.exceptions>`
        """
        response = requests.delete(f"{self.api}/g/s/user-profile/{self.uid}/linked-community/{comId}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def watch_ad(self, userId: str = None):
        data = json.dumps(tapjoy.Tapjoy(userId if userId else self.uid).data)
        response = requests.post("https://ads.tapdaq.com/v4/analytics/reward", data=data, headers=self.tapjoy_headers)
        if response.status_code != 204: print(response.status_code); return Exception(response.text)
        else: return response.status_code
