...
def net_io():
    ...
    try:
      ...
      error_msg = "Function 'net_io' not available without 'psutil' package installed."
...
def disk_stats():
    ...
    try:
      ...
      error_msg = "Function 'disk_stats' not available without 'psutil' package installed."
      LOG.critical(error_msg)
      raise ImportError(error_msg)
...
def cpu_times_percent(interval=1):
    ...
    try:
      ...
      error_msg = "Function 'cpu_times_percent' not available without 'psutil' package installed."
      LOG.critical(error_msg)
      raise ImportError(error_msg)
