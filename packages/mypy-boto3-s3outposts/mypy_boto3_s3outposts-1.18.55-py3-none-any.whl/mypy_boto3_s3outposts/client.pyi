...
class S3OutpostsClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/s3outposts.html#S3Outposts.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/s3outposts.html#S3Outposts.Client.can_paginate)
    ...
    def create_endpoint(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/s3outposts.html#S3Outposts.Client.create_endpoint)
    ...
    def delete_endpoint(self, *, EndpointId: str, OutpostId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/s3outposts.html#S3Outposts.Client.delete_endpoint)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/s3outposts.html#S3Outposts.Client.generate_presigned_url)
    ...
    def list_endpoints(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/s3outposts.html#S3Outposts.Client.list_endpoints)
    ...
    def get_paginator(self, operation_name: Literal["list_endpoints"]) -> ListEndpointsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/s3outposts.html#S3Outposts.Paginator.ListEndpoints)
