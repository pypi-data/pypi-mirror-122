...
class Configuration:
    def __init__(self, indices, config_a, config_b):
...
class State:
    ...
    def add_config_line(self, MO_indices, config_a, config_b ):
        self.configurations.append(Configuration(MO_indices, config_a, config_b))
