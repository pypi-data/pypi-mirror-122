...
usage: web-minify.py [-h] [--version] [--mode {minify,beautify}]
                     [--format FORMAT] [--overwrite] [--on-change] [--verbose]
                     [--force] [--zipy] [--disable-js] [--disable-css]
                     [--disable-html] [--disable-svg] [--disable-png]
                     [--disable-jpeg] [--output OUTPUT] [--sort] [--comments]
                     [--timestamp] [--wrap] [--set-precision NUM]
