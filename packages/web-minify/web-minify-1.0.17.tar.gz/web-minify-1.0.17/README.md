...
usage: web-minify.py [-h] [--version] [--mode {Mode.minify,Mode.beautify}]
                     ...
                     [--disable-type-jinja] [--disable-type-png]
                     [--disable-type-svg] [--disable-type-json]
                     [--disable-type-html] [--disable-type-js]
                     [--disable-type-css] [--disable-type-jpeg]
                     [--disable-type-sass] [--disable-suffix-jinja]
                     [--disable-suffix-png] [--disable-suffix-svg]
                     [--disable-suffix-json] [--disable-suffix-html]
                     [--disable-suffix-js] [--disable-suffix-htm]
                     [--disable-suffix-css] [--disable-suffix-jpg]
                     [--disable-suffix-jinja2] [--disable-suffix-j2]
                     [--disable-suffix-jpeg] [--disable-suffix-sass]
