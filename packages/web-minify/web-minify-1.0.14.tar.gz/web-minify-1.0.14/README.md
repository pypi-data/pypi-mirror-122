...
usage: web-minify.py [-h] [--version] [--mode {Mode.minify,Mode.beautify}]
                     ...
                     [--force] [--nproc NUM] [--gzip] [--disable-type-html]
                     [--disable-type-svg] [--disable-type-jinja]
                     [--disable-type-sass] [--disable-type-png]
                     [--disable-type-js] [--disable-type-css]
                     [--disable-type-jpeg] [--disable-type-json]
                     [--disable-suffix-html] [--disable-suffix-svg]
                     [--disable-suffix-jinja] [--disable-suffix-sass]
                     [--disable-suffix-png] [--disable-suffix-jinja2]
                     [--disable-suffix-htm] [--disable-suffix-js]
                     [--disable-suffix-css] [--disable-suffix-j2]
                     [--disable-suffix-jpeg] [--disable-suffix-jpg]
                     [--disable-suffix-json] [--output OUTPUT] [--sort]
