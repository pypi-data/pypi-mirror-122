...
def get_exception_message(merchant_id: str, access_token: Optional[str] = None) -> str:
    if access_token:
...
def get_mct_account_details(
    ...
    # RefreshError is raised when we have invalid merchant_id or we don't have access to the account
        ...
        raise MctAccountLostAccessException(get_exception_message(access_token, merchant_id))
