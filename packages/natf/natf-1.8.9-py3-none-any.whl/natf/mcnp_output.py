...
def read_cell_neutron_flux_single_tally_single_group(filename, tally_num=4):
    """
            ...
            while True:
                ...
                if " cell " in line1:
                    ...
                    for j in range(len(cid)):
                        fluxes.append(float(line_ele[2 * j]))
...
def tallied_vol_to_tally(inp="outp", output="tally_card.txt"):
    ...
    cids, vols, errs = read_cell_neutron_flux_single_tally_single_group(
