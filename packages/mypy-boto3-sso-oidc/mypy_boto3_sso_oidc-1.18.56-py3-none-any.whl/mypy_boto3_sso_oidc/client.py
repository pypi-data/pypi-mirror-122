...
class SSOOIDCClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/sso-oidc.html#SSOOIDC.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/sso-oidc.html#SSOOIDC.Client.can_paginate)
    ...
    def create_token(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/sso-oidc.html#SSOOIDC.Client.create_token)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/sso-oidc.html#SSOOIDC.Client.generate_presigned_url)
    ...
    def register_client(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/sso-oidc.html#SSOOIDC.Client.register_client)
    ...
    def start_device_authorization(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/sso-oidc.html#SSOOIDC.Client.start_device_authorization)
