...
class SOAPHandlerBase():
    ...
    def _send_request(self, verb: VERBMAP, url: str, data, headers, log=False):
        """
        ...
        response = self._receive_response(req_log, r, log)
    ...
    def _receive_response(self, request_logger, response, log=False) -> SoapResult:
        """
    ...
    def post(self, envelope_path=None, envelope_attributes=None, log=False) -> SoapResult:
        """
