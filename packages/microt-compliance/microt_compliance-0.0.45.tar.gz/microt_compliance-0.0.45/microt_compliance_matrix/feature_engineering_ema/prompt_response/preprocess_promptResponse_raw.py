...
def extract_reprompt(df_pr_phone):
    ...
    if df_prompt.shape[0] > 0:
        df_prompt.columns = ['Prompt_Type', 'Study_Mode', 'Initial_Prompt_Local_Time', 'Answer_Status', 'Prompt_Local_Time', 'UTC_Offset', "Reprompt_Num"]
...
def clean_response_files(intermediate_participant_path, date_in_study, participant_id):
    ...
    for idx in df_reprompt.index:
        prompt_local_time_timezone = df_reprompt['Prompt_Local_Time'][idx]
