...
def compute_features_phone(intermediate_participant_path, output_dir_path, date_in_study, lsf_json_folder_path,
    ...
    feature5, feature6, match_time_battery = feature_engineering_ema.battery_level.create_column(
        df_prompt['Prompt_Local_DateTime'], intermediate_participant_path, date_in_study)
    ...
    feature7, match_time_location = feature_engineering_ema.location.create_column(df_prompt['Prompt_Local_DateTime'],
    ...
    feature10, feature11 = feature_engineering_ema.waking_hours.create_column(df_prompt['Prompt_Local_DateTime'],
                                                                              intermediate_participant_path,
                                                                              date_in_study)
    ...
    df_mims = feature_engineering_ema.mims_summary.create_column(df_prompt['Prompt_Local_DateTime'],
