...
def test_oracle_types(oracle_url: str) -> None:
    ...
    expected = pd.DataFrame(
        data={
            ...
            "TEST_BINARY_FLOAT": pd.Series([-3.456, 3.1415926535, 3.1415926535, None], dtype="float64"),
            "TEST_BINARY_DOUBLE": pd.Series([9999.99991, -111111.2345, -111111.2345, None], dtype="float64"),
            "TEST_CHAR": pd.Series(['char1', 'char2', 'char2', None], dtype="object"),
            "TEST_VARCHAR": pd.Series(['varchar1', 'varchar222', 'varchar222', None], dtype="object"),
            "TEST_NCHAR": pd.Series(['y123  ', 'aab123', 'aab123', None], dtype="object"),
            "TEST_NVARCHAR": pd.Series(['aK>?KJ@#$%', ')>KDS)(F*&%J', ')>KDS)(F*&%J', None], dtype="object"),
            "TEST_DATE": pd.Series(['2019-05-21', '2020-05-21', '2020-05-21',  None], dtype="datetime64[ns]"),
            "TEST_TIMESTAMP": pd.Series(['2019-05-21 01:02:33', '2020-05-21 01:02:33', '2020-05-21 01:02:33', None], dtype="datetime64[ns]"),
            "TEST_TIMESTAMPTZ": pd.Series(['1999-12-01 11:00:00', '1899-12-01 11:00:00', '1899-12-01 11:00:00', None], dtype="datetime64[ns]"),
        }
    )
    assert_frame_equal(df, expected, check_names=True)
