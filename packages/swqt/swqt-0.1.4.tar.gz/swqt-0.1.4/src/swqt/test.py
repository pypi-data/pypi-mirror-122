...
from omulet import ShockwaveWidget, InputLineEdit, FuncButton, ElementGroup, FuncWidget, ShadowLabel
...
class Main(FuncWidget):
    def __init__(self, size: QRect):
        ...
        self.ll = ShadowLabel(QColor('dodgerblue'), 'left', 9, self)

        # self.ll = ShadowLabel('red', 'full', 9, self)

        # self.ll = QLabel(self)

        self.ll.setGeometry(1, 0, 300, self.height())

        # self.ll.setGeometry(100, 100, 300, 300)
