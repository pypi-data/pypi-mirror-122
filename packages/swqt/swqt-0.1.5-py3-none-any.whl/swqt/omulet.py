...
class FuncLabel(QLabel):
    def __init__(self, pos, bg_color: str, p):
    ...
    def set_color(self):
        self.setStyleSheet('''background-color:%s''' % self.bg_color)


class TitleLabel(FuncLabel):
    def __init__(self, pos, bg_color: str, p):
        super(TitleLabel, self).__init__(pos, bg_color, p)


class ShadowLabel(FuncLabel):
    def __init__(self, bg_color, shadow_pos: str, step=5, p=None, pos=None):
        """
        ...
        :param p: parent
        """
        super(ShadowLabel, self).__init__(pos, bg_color, p)
        self.step = step
