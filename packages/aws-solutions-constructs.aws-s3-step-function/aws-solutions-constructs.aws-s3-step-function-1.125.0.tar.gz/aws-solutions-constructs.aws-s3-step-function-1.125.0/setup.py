    ...
    """
{
    ...
    "package_data": {
        "aws_solutions_constructs.aws_s3_step_function._jsii": [
            "aws-s3-step-function@1.125.0.jsii.tgz"
        ],
        "aws_solutions_constructs.aws_s3_step_function": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-constructs.aws-events-rule-step-function==1.125.0",
        "aws-solutions-constructs.aws-s3-stepfunctions==1.125.0",
