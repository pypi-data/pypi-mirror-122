...
class FindValuesTC(unittest.TestCase):
    def setUp(self):
        ...
        for r in self.testdata:
            ...
            self.ftd.commit()
        rd = {k: "".join((v, str(4).zfill(4))) for k, v in self.trdata.items()}
        self.ftd.start_transaction()
        for r in range(10):
    ...
    def test_find_values(self):
        ...
        self.check_name_index(
            {"whitedata2"}, above_value="blackdata0", below_value="whitedata3"
        )
        self.check_name_index(
        ...
        self.check_name_index(
            {"whitedata2", "whitedata3"}, above_value="blackdata0"
        )
        self.check_name_index(
            {"blackdata0", "black0004"}, below_value="whitedata2"
        )
        self.check_name_index({"whitedata3"}, from_value="whitedata3")
        self.check_name_index(
            {"whitedata2", "black0004", "blackdata0"}, to_value="whitedata2"
        )
        self.check_name_index(set(), in__set={})
        self.check_name_index(
            set(),
            above_value="blackdata0",
            below_value="whitedata3",
        ...
        self.check_name_index(
            set(), above_value="blackdata0", to_value="whitedata3", in__set={}
        )
        self.check_name_index(
            set(),
            from_value="blackdata0",
        ...
        self.check_name_index(
            set(), from_value="blackdata0", to_value="whitedata3", in__set={}
        )
        self.check_name_index(set(), above_value="blackdata0", in__set={})
        self.check_name_index(set(), below_value="whitedata2", in__set={})
        self.check_name_index(set(), from_value="whitedata3", in__set={})
        self.check_name_index(set(), to_value="whitedata2", in__set={})
        self.check_name_index(
        ...
        self.check_name_index(
            {"black0004", "blackdata0"}, like_pattern=like_pattern
        )
        self.check_name_index(
            {"whitedata2", "whitedata3"}, like=False, like_pattern=like_pattern
        )
        self.check_name_index(
            {"black0004", "blackdata0"},
            in_=False,
