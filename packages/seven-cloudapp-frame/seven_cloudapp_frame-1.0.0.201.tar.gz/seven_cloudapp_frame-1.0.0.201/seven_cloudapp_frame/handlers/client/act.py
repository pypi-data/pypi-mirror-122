...
@LastEditTime: 2021-10-09 10:59:40
...
class ActPrizeListHandler(ClientBaseHandler):
    ...
    def get_async(self):
        ...
        page_list, total = prize_base_model.get_act_prize_list(app_id, act_id, module_id, prize_name, 0, 0, page_size, page_index, order_by=order_by, condition=condition, params=params, is_cache=False)
