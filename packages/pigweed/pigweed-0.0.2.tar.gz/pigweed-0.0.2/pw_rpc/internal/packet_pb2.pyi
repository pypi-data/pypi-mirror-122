...
class RpcPacket(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"channel_id",b"channel_id",u"method_id",b"method_id",u"payload",b"payload",u"service_id",b"service_id",u"status",b"status",u"type",b"type"]) -> None: ...
