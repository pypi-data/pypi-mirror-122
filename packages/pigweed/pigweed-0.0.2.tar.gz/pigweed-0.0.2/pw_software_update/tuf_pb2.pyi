...
class RootMetadata(google.protobuf.message.Message):
    ...
    TARGET_SIGNATURE_REQUIREMENT_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def target_signature_requirement(self) -> global___SignatureRequirement: ...
    def __init__(self,
        *,
