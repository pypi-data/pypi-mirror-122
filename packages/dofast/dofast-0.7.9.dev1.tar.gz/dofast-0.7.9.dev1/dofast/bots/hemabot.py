...
class Psycho:
    ...
    def text_handler(self, update: Update, context: CallbackContext) -> None:
        ...
        if api.textparser.match(['weather', '天气'], text):
            # res = api.weather._daily(markdown=True)
            from dofast.bots.bothelper import BotHelper
            BotHelper().draw_weather_image()
            ...
            update.message.reply_text(res, parse_mode=ParseMode.MARKDOWN_V2)
