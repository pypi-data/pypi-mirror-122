...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '3.8.0-alpha.1633360745+9fe7bfc4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 3.8.0-alpha.1633360745+9fe7bfc4`
                """)
            else:
                raise
