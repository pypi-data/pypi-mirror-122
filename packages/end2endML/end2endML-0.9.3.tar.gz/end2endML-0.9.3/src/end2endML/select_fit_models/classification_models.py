...
def train_classification_models(
    ...
    if "clf_linear" in clf_models:
        ...
        if verbose == 1:
            print(
                f"{round(toc, 4)} seconds were taken to select and fit the logistic linear model. \n {'-' * 50}"
            )
    ...
    if "clf_lasso" in clf_models:
        ...
        if verbose == 1:
            print(
                f"{round(toc, 4)} seconds were taken to select and fit the logistic linear model with"
                f" lasso penalty. \n {'-' * 50}"
            )
    ...
    if "clf_svm" in clf_models:
        ...
        if verbose == 1:
            print(
                f"{round(toc, 4)} seconds were taken to select and fit the svm model. \n {'-' * 50}"
            )
    ...
    if "clf_nn" in clf_models:
        ...
        if verbose == 1:
            print(
                f"{round(toc, 4)} seconds were taken to select and fit the neural network model. \n {'-' * 50}"
            )
    ...
    if "clf_gb" in clf_models:
        ...
        if verbose == 1:
            print(
                f"{round(toc, 4)} seconds were taken to select and fit the gradient boosting model. \n {'-' * 50}"
            )
    ...
    if "clf_rf" in clf_models:
        ...
        if verbose == 1:
            print(
                f"{round(toc, 4)} seconds were taken to select and fit the random forest model are done. \n {'-' * 50}"
            )
