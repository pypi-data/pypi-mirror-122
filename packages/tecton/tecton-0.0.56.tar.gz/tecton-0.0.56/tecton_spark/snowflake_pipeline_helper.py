...
def _load_template():
    ...
    if not TIME_LIMIT_TEMPLATE:
        TIME_LIMIT_TEMPLATE = load_template("pipeline_time_limit.sql.j2")
...
def pipeline_to_sql_string(
    ...
    # This will apply a time limit for the sql string being returned, time is inclusive
    time_limits: pendulum.Period = None,
    # Needed when time_limits is provided
...
class _PipelineBuilder:
    ...
    def __init__(
        ...
        # This will apply a time limit for the sql string being returned
        time_limit: pendulum.Period = None,
        # Needed when time_limits is provided
        timestamp_key: str = None,
    ):
    ...
    def get_sql_string(self) -> str:
        ...
        if self._time_limit:
            sql_str = TIME_LIMIT_TEMPLATE.render(
                ...
                start_time=self._time_limit.start,
                end_time=self._time_limit.end,
            )
        return sql_str
