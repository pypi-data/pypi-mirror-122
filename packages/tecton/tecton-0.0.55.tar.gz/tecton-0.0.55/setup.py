...
setuptools.setup(
    ...
    extras_require={'databricks-connect': ['databricks_connect~=6.4.28', 'pyarrow==0.13.0'], 'databricks-connect7': ['databricks-connect~=7.3.22', 'pyarrow==0.15.1'], 'databricks-connect9': ['databricks-connect~=9.1.0', 'pyarrow==4.0.0'], 'pyspark': ['pyspark==2.4.4', 'pyarrow==0.13.0'], 'pyspark3': ['pyspark==3.0.1', 'pyarrow==0.15.1'], 'pyspark3.1': ['pyspark==3.1.2', 'pyarrow==4.0.0']},
    packages=packages,
)
