...
setup(
  ...
  description = 'To scrape live optionschain data from upstox for free (without api)',   # Give a short description about your library
  ...
  download_url = 'https://github.com/MaticAlgos/liveupstoxoc/archive/refs/tags/0.1.3.tar.gz',    # I explain this later on
