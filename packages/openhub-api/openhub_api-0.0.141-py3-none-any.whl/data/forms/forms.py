...
class DataTransformerForm(BaseInlineFormSet):
    ...
    def as_p(self):
        forms = ' '.join(' '.join([form.as_p(),form.nested_data_transformer_form.as_p(),form.nested_constants_form.as_p(),form.nested_hardware_outputs_form.as_p(),form.nested_hardware_stats_form.as_p()]) for form in self)
