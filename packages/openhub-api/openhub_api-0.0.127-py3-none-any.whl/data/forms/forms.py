...
class DataTransformerForm(BaseInlineFormSet):
    ...
    def add_fields(self, form, index):
        ...
        dataTransformerInlineFormset = inlineformset_factory(DataTransformer, DataTransformer,formset=self,
                                                             fk_name='data_transformer_parent',
                                                             extra=1, exclude=['updated_at', 'created_at'],
                                                             form=self.DataTransform)
    ...
    def as_p(self):
        super(DataTransformerForm, self).as_p()
        forms = ' '.join(' '.join([form.as_p(),form.nested_data_transformer_form,form.nested_constants_form,form.nested_hardware_outputs_form,form.nested_hardware_stats_form]) for form in self)
...
class DataTransform(forms.ModelForm):
    ...
    data_transformer_parent = forms.CharField(required=False,
                                              widget=forms.HiddenInput(attrs={'class': 'form-control'}))
    ...
    class Meta:
        ...
        fields = ['id','accessory','data_transformer_parent','type']
