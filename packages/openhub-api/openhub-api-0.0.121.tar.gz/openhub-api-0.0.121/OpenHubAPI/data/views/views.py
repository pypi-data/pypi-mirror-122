...
class AccessoryViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        if accessory.has_data_transformer:
            data_transformer = accessory.data_transformer
            datatransformerset = formset_factory(DataTransform(instance=data_transformer), formset=DataTransformerForm, extra=0)
