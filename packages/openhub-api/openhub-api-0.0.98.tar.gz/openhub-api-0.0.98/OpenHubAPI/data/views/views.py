...
from data.forms.forms import DataTransformerForm
...
class AccessoryViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        if accessory.hasattr('datatransformer'):
            data_transformer = accessory.datatransformer
            formset = DataTransformerForm(instance=data_transformer)
        else:
            formset = DataTransformerForm()
