...
class DataTransform(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.fields['parent'] is not None and self.fields['parent'] != '':
            self.fields['accessory'] = forms.ModelChoiceField(required=True, queryset=DataTransformer.objects.get(self.fields['parent'].value()).accessory,
                                                    widget=forms.HiddenInput(attrs={'class': 'form-control'}),
                                                    initial=str(DataTransformer.objects.get(self.fields['parent'].value()).accessory.pk))
...
class DataTransformRoot(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['accessory'].queryset = Accessory.objects.get(self.instance.accessory.pk)
