...
class DataTransform(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            if self.instance.get_children().count() >= 0:
                ...
                self.nested_data_transformer_form = dataTransformerInlineFormset(
                    ...
                    initial=[{'parent': str(self.instance.pk), 'accessory': str(self.instance.accessory.id), 'id':str(uuid.uuid4())}],
        ...
        hardware_outputs = self.instancehardwaredatatransformer_set.first()
