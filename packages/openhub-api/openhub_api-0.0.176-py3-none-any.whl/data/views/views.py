...
class AccessoryViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        if accessory.has_data_transformer:
            ...
            data_transformer = DataTransformer.objects.create(accessory=accessory,parent=data_transformer_root)
            data_transformer.save()
            formset = datatransformerset(instance=data_transformer_root)
