...
from django.forms.models import inlineformset_factory,BaseForm,form_factory
...
DataTransformerInlineFormset = inlineformset_factory(DataTransformer, DataTransformer, extra=1)
