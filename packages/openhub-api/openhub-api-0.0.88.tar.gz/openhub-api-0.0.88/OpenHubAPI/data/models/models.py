...
class HardwareStats(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4)
    hardwares = models.ForeignKey(Hardware, on_delete=models.CASCADE, blank=True, null=True, default=None)
    type = models.CharField(max_length=255, null=True)
...
class DataTransformer(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4)
    accessory = place = models.OneToOneField(
        Accessory,
        on_delete=models.CASCADE
    )
    data_transformer_parent = models.ForeignKey('self', on_delete=models.CASCADE, blank=True, null=True, default=None)
    data_transformer_child = models.ForeignKey('self', on_delete=models.CASCADE, blank=True, null=True, default=None)
...
class DataTransformerConstants(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4)
    data_transformer = models.ForeignKey(DataTransformer, on_delete=models.CASCADE, blank=True, null=True, default=None)
    type = models.CharField(max_length=255, null=True)
...
class HardwareDataTransformer(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4)
    hardware = models.ForeignKey(Hardware, on_delete=models.CASCADE, blank=True, null=True, default=None)
    data_transformer = models.ForeignKey(DataTransformer,on_delete=models.CASCADE, blank=True, null=True, default=None)
    index = models.IntegerField()
    updated_at = models.DateTimeField(auto_now=True)
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    class Meta:
        indexes = [
            models.Index(fields=['id','data_transformer','hardware']),
        ]
