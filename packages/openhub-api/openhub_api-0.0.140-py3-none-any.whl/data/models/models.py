...
class Accessory(models.Model):
    ...
    def has_data_transformer(self):
        return hasattr(self, 'datatransformer_set') or hasattr(self, 'data_transformer_set')
...
TreeForeignKey(DataTransformer, on_delete=models.CASCADE, blank=True, null=True).contribute_to_class(DataTransformer, 'parent')
mptt.register(DataTransformer)
