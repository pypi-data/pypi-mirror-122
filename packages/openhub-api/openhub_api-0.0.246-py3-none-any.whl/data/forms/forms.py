    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            if self.instance.get_children().count() >= 0:
                ...
                self.nested_data_transformer_form.extra = self.instance.get_children().count() + 1
        ...
        self.nested_constants_form.extra = self.instance.datatransformerconstants_set.count() + 1
        ...
        self.nested_hardware_outputs_form = HardwareTransformerInlineFormset(
            ...
            data=self.data if self.is_bound else None,
            files=self.files if self.is_bound else None,
            prefix=str(self.instance.id)+'HardwareTransformerInlineFormset',
            initial=[{'data_transformer': self.instance, 'id': str(uuid.uuid4())}]
        )
        self.nested_hardware_outputs_form.extra = self.instance.hardwaredatatransformer_set.count() + 1
        ...
        self.nested_hardware_stats_form.extra = self.instance.hardwarestatsdatatransformer_set.count() + 1
