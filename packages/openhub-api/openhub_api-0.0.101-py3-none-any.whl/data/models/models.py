...
class Accessory(models.Model):
    ...
    def has_data_transformer(self):
        return hasattr(self, 'datatransformer') or hasattr(self, 'data_transformer')
...
class DataTransformer(models.Model):
    ...
    data_transformer_parent = models.ForeignKey('self', related_name = 'data_parent',on_delete=models.CASCADE, blank=True, null=True, default=None)
    data_transformer_child = models.ForeignKey('self', related_name = 'data_child',on_delete=models.DO_NOTHING, blank=True, null=True, default=None)
