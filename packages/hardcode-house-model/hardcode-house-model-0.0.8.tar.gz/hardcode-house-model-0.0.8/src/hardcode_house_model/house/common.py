...
from mongoengine.fields import (BooleanField, DateTimeField, DecimalField,
                                EmbeddedDocument, EmbeddedDocumentField,
                                FloatField, ListField, StringField, URLField)


class HouseProperty(EmbeddedDocument):
...
class TransactionProperty(EmbeddedDocument):
...
class GeographicCoordinate(EmbeddedDocument):
    latitude = FloatField()
...
class HouseLocation(EmbeddedDocument):
    city = StringField()
...
class HouseQuotation(EmbeddedDocument):
