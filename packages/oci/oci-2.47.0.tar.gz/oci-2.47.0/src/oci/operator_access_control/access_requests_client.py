...
class AccessRequestsClient(object):
    ...
    def approve_access_request(self, access_request_id, approve_access_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.47.0/operatoraccesscontrol/approve_access_request.py.html>`__ to see an example of how to use approve_access_request API.
        """
    ...
    def get_access_request(self, access_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.47.0/operatoraccesscontrol/get_access_request.py.html>`__ to see an example of how to use get_access_request API.
        """
    ...
    def list_access_request_histories(self, access_request_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.47.0/operatoraccesscontrol/list_access_request_histories.py.html>`__ to see an example of how to use list_access_request_histories API.
        """
    ...
    def list_access_requests(self, compartment_id, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.47.0/operatoraccesscontrol/list_access_requests.py.html>`__ to see an example of how to use list_access_requests API.
        """
    ...
    def reject_access_request(self, access_request_id, reject_access_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.47.0/operatoraccesscontrol/reject_access_request.py.html>`__ to see an example of how to use reject_access_request API.
        """
    ...
    def revoke_access_request(self, access_request_id, revoke_access_request_details, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.47.0/operatoraccesscontrol/revoke_access_request.py.html>`__ to see an example of how to use revoke_access_request API.
        """
