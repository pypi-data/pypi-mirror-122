...
# sources: wechaty/puppet/base.proto, wechaty/puppet/contact.proto, wechaty/puppet/event.proto, wechaty/puppet/file-box.proto, wechaty/puppet/friendship.proto, wechaty/puppet/location.proto, wechaty/puppet/message.proto, wechaty/puppet/mini-program.proto, wechaty/puppet/room-invitation.proto, wechaty/puppet/room-member.proto, wechaty/puppet/room.proto, wechaty/puppet/tag.proto, wechaty/puppet/url-link.proto
...
class RoomInvitationPayloadResponse(betterproto.Message):
    ...
    # * @deprecated will be removed after Dec 31, 2022  Huan(202109): use
    # receive_time(10) instead
    timestamp_deprecated: int = betterproto.uint64_field(6)
    ...
    def __post_init__(self) -> None:
        ...
        if self.timestamp_deprecated:
            warnings.warn(
                "RoomInvitationPayloadResponse.timestamp_deprecated is deprecated",
                DeprecationWarning,
            )
