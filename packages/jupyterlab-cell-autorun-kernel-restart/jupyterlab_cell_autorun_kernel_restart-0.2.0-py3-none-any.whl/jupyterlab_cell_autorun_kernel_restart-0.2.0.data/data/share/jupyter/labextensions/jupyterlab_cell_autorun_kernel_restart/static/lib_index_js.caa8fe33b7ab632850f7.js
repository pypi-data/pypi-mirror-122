...
class KernelReInitButton extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton {
    ...
    toggleInitCell() {
        ...
        if (this.nbtracker.currentWidget && cell) {
            const present_scene = (_a = this.getPresentScene(this.nbtracker.currentWidget)) === null || _a === void 0 ? void 0 : _a.toString();
...
//# sourceMappingURL=lib_index_js.caa8fe33b7ab632850f7.js.map