...
class KernelReInitButton extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton {
    ...
    attach(nbpanel) {
        ...
        console.log('xxx', (_a = nbpanel.content.model) === null || _a === void 0 ? void 0 : _a.metadata.get('ReInit'));
    }
    /**
     * Privates
     */
    setDefaultNotebookMetadataIfNotPresent(nbmodel) {
        if (nbmodel) {
            console.log('yyy', nbmodel.metadata.get('ReInit'));
        }
        else {
...
//# sourceMappingURL=lib_index_js.0f23f1c2ea87fc67a70e.js.map