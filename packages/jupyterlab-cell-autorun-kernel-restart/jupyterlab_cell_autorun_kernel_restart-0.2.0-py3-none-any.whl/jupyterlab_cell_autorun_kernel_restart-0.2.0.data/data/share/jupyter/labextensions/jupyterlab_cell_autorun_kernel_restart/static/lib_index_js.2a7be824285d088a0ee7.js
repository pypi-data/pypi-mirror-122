        ...
        if (nbpanel.content.model) {
            ...
            if (!cell0.model.metadata.get('reinit_data')) {
                ...
                let reinit_cell = new _jupyterlab_cells__WEBPACK_IMPORTED_MODULE_2__.CellModel({
                    cell: { cell_type: 'raw', source: ['ReInit Data Cell'], metadata: { reinit_data: true, scenes: ['default'], default_scene: 'default' } }
                });
...
//# sourceMappingURL=lib_index_js.2a7be824285d088a0ee7.js.map