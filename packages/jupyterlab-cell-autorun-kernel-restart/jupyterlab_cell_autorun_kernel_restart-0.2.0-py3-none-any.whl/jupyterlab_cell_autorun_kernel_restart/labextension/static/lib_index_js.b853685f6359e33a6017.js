...
class KernelReInitButton extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton {
    ...
    attach(nbpanel) {
        ...
        (_b = (_a = this.nbtracker.currentWidget) === null || _a === void 0 ? void 0 : _a.content.model) === null || _b === void 0 ? void 0 : _b.cells.insert(0, new _jupyterlab_cells__WEBPACK_IMPORTED_MODULE_2__.CellModel({ cell: { cell_type: 'raw', source: ['ab'], metadata: {} }, }));
    }
    /**
     * Privates
     */
    ...
    onAllCellsInNotebookReady(nbpanel) {
        ...
        if (nbpanel.content.model) {
            ...
            if (cell0.model.id != reinit_cell_id) {
                ...
                let reinit_cell = new _jupyterlab_cells__WEBPACK_IMPORTED_MODULE_2__.CellModel({ cell: { cell_type: 'raw', source: ['ReInit Data Cell'], metadata: { scenes: ['default'], default_scene: 'default' } } });
                nbpanel.content.model.cells.insert(0, reinit_cell);
            }
            // nbpanel.content.model.cells.insert
        }
    }
...
//# sourceMappingURL=lib_index_js.b853685f6359e33a6017.js.map