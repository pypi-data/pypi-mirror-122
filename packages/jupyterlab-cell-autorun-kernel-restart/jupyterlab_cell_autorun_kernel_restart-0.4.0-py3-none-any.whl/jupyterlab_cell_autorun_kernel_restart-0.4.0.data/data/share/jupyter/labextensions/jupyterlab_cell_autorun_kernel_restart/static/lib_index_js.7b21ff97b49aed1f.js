...
class ReInit {
    ...
    deletePresentScene() {
        ...
        if (!nbpanel)
            return;
        _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.InputDialog.getItem({ title: 'Do you really want to delete scene "' + present_scene + '"?', items: ['a', 'b'] }).then((res) => {
...
//# sourceMappingURL=lib_index_js.7b21ff97b49aed1f.js.map