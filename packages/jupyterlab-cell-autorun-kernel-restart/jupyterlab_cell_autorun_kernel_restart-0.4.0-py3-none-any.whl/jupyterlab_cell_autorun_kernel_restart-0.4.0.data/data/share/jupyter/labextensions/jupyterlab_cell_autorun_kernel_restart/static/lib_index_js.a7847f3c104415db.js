...
class ReInit {
    ...
    async doReInit() {
        ...
        const result = await (new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Dialog({
            ...
            buttons: [_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Dialog.okButton({ label: 'Restart' }), _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.Dialog.cancelButton()]
        }).launch());
...
//# sourceMappingURL=lib_index_js.a7847f3c104415db.js.map