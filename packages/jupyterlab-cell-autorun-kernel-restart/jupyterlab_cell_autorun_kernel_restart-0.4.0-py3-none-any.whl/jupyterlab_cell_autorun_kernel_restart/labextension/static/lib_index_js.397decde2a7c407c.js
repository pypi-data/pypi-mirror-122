...
class ReInit {
    ...
    async deletePresentScene() {
        ...
        _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.InputDialog.getBoolean({ title: 'Do you really want to delete scene "' + present_scene + '"?' }).then((res) => {
...
//# sourceMappingURL=lib_index_js.397decde2a7c407c.js.map