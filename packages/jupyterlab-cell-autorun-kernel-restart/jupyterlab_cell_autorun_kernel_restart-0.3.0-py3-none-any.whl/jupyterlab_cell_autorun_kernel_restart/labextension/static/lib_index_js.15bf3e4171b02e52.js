...
class ReInit {
    ...
    // **** setup helpers **********************************************************************************************************************
    setupReinitMenu() {
        const reinit_menu = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_3__.Menu({ commands: this.app.commands });
        ...
        reinit_menu.addItem({ type: 'separator' });
        this.submenu = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_3__.Menu({ commands: this.app.commands });
    ...
    addDefaultReinitDataCellIfNotPresent(nbpanel) {
        if (nbpanel.content.model) {
            ...
            console.log('a', cell0);
            console.log('b', cell0.model);
            if (!cell0.model.metadata.get('reinit_data')) {
                if (verbose)
                    console.log('Adding default ReInit Data Cell');
                var reinit_cell = new _jupyterlab_cells__WEBPACK_IMPORTED_MODULE_1__.CellModel({
...
const plugin = {
    ...
    autoStart: true,
    requires: [_jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_2__.INotebookTracker, _jupyterlab_mainmenu__WEBPACK_IMPORTED_MODULE_0__.IMainMenu],
...
//# sourceMappingURL=lib_index_js.15bf3e4171b02e52.js.map