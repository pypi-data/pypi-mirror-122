...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".cell-autorun-kernel-restart-enabled .CodeMirror:after {\n    height: 10px;\n    width: 10px;\n    display: block;\n    content: '';\n    position: absolute;\n    right: 10px;\n    top: 10px;\n    border-radius: 50%;\n    background-color: lightblue;\n}\n", "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAAA;IACI,YAAY;IACZ,WAAW;IACX,cAAc;IACd,WAAW;IACX,kBAAkB;IAClB,WAAW;IACX,SAAS;IACT,kBAAkB;IAClB,2BAA2B;AAC/B","sourcesContent":[".cell-autorun-kernel-restart-enabled .CodeMirror:after {\n    height: 10px;\n    width: 10px;\n    display: block;\n    content: '';\n    position: absolute;\n    right: 10px;\n    top: 10px;\n    border-radius: 50%;\n    background-color: lightblue;\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.a6a04dcc1b9225a87757.js.map