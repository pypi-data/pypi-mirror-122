...
class KernelReInitButton extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton {
    ...
    setDefaultNotebookMetadataIfNotPresent(nbmodel) {
        if (nbmodel) {
            console.log('c');
            if (nbmodel.metadata.get('ReInit') == null) {
                console.log('a');
                nbmodel.metadata.set('ReInit', { 'scenes': ['default'], 'active-scene': 'default' });
            }
        }
        else {
...
//# sourceMappingURL=lib_index_js.f1fc46501481bb75bdbc.js.map