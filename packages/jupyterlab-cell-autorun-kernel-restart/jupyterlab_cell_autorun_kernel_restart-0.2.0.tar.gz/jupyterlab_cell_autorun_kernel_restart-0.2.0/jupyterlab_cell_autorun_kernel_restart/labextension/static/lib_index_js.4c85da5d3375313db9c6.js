...
class KernelReInitButton extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.ToolbarButton {
    ...
    duplicatePresentScene() {
        ...
        if (nbpanel) {
            ...
            _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_0__.InputDialog.getText({ title: 'Name of the duplicated scene:' }).then(new_scene => {
                if (new_scene.value) {
...
//# sourceMappingURL=lib_index_js.4c85da5d3375313db9c6.js.map