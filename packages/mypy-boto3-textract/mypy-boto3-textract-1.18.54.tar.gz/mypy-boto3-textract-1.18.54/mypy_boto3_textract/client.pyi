...
class TextractClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client)
    ...
    def analyze_document(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client.analyze_document)
    ...
    def analyze_expense(self, *, Document: "DocumentTypeDef") -> AnalyzeExpenseResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client.analyze_expense)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client.can_paginate)
    ...
    def detect_document_text(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client.detect_document_text)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client.generate_presigned_url)
    ...
    def get_document_analysis(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client.get_document_analysis)
    ...
    def get_document_text_detection(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client.get_document_text_detection)
    ...
    def start_document_analysis(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client.start_document_analysis)
    ...
    def start_document_text_detection(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/textract.html#Textract.Client.start_document_text_detection)
