...
def find_file(search_path: str, key='', exclude_key=None, use_regex=False, recursive=True, return_relative_path=True, return_deepest_path=False, disable_alert=False) -> str:
    '''
    'dir_path': path to search
    'key': find a set of files/dirs whose absolute path contain the 'key',
    'exclude_key': file whose absolute path contains 'exclude_key' will be ignored
...
def find_dir(search_path: str, key='', exclude_key=None, use_regex=False, recursive=True, return_relative_path=True, return_deepest_path=False, disable_alert=False) -> str:
    '''
    'dir_path': path to search
    'key': find a set of files/dirs whose absolute path contain the 'key',
    'exclude_key': file whose absolute path contains 'exclude_key' will be ignored
...
def find_cwd_file(key='', use_regex=False, exclude_key=None, recursive=True, return_relative_path=True, return_deepest_path=False, disable_alert=False):
    '''
    'key': find a set of files/dirs whose absolute path contain the 'key',
    'exclude_key': file whose absolute path contains 'exclude_key' will be ignored
    'recursive' recursive search in dir_path
    ...
    '''
    return find_file(os.getcwd(), key, use_regex, exclude_key, recursive, return_relative_path, disable_alert)
...
def find_cwd_dir(key='', use_regex=False, exclude_key=None, recursive=True, return_relative_path=True, return_deepest_path=False, disable_alert=False):
    '''
    'key': find a set of files/dirs whose absolute path contain the 'key',
    'exclude_key': file whose absolute path contains 'exclude_key' will be ignored
    'recursive' recursive search in dir_path
    ...
    return find_dir(os.getcwd(), key, use_regex, exclude_key, recursive, return_relative_path, return_deepest_path, disable_alert)
