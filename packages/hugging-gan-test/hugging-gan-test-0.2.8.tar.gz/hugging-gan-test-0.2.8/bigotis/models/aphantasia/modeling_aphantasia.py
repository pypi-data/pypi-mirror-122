...
class Aphantasia(ImageGenerator):
    ...
    def generate_from_prompt(
        ...
        **kwargs,
        ...
        for step in range(num_steps):
            ...
            initial_img = self.get_img_rec_from_latents(latents=fft_img, )
            ...
            with torch.no_grad():
                rec_img = self.get_img_rec_from_latents(latents=fft_img, )
    ...
    def interpolate(
        ...
        **kwargs,
        ...
        Args:
            fft_img_list (List[torch.Tensor]): list of fft tensors
