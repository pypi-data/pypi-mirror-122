...
class ImageGenerator(
    ...
    def augment(
        ...
        if target_img_height is None:
            target_img_height = img_batch.shape[3]
        ...
        for crop_idx in range(num_crops):
            ...
            augmented_img = aug_img_batch[:, :, offsetx:offsetx + crop_size,
            ...
            if target_img_height != target_img_width:
                min_size = min(target_img_width, target_img_height)
                augmented_img = torchvision.transforms.RandomCrop(
                    (min_size, min_size))(augmented_img)
