...
class ProviderManager:
    """Manages config and operation of a local flask webserver that serves a provider set and the privuder factory.
    ...
    def __init__(
        ...
        self.factory_thread = _FactoryThread(self.host, self.port, user_id)
