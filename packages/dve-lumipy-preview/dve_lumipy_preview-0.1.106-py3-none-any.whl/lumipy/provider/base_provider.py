...
def _cast(name: str, value: Any, data_type: str) -> Union[int, float, str, bool, DataFrame]:
    ...
    def blueprint(self) -> Blueprint:
        ...
        def provider_data():
            ...
            try:
                ...
                response = self._get_data(data_filter, limit, **param_dict)
                ...
                return Response(json.dumps(err_data), status=400)
