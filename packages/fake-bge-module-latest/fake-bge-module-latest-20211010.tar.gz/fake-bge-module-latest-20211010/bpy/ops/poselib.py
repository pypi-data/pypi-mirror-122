...
def apply_pose_asset_for_keymap():
    ''' Apply the given Pose Action to the rig :file: addons/pose_library/operators.py\:436 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$436> _
...
def blend_pose_asset_for_keymap():
    ''' Blend the given Pose Action to the rig :file: addons/pose_library/operators.py\:414 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$414> _
...
def convert_old_poselib():
    ''' Create a pose asset for each pose marker in the current action :file: addons/pose_library/operators.py\:458 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$458> _
...
def copy_as_asset():
    ''' Create a new pose asset on the clipboard, to be pasted into an Asset Browser :file: addons/pose_library/operators.py\:225 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$225> _
...
def paste_asset():
    ''' Paste the Asset that was previously copied using Copy As Asset :file: addons/pose_library/operators.py\:300 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$300> _
...
def restore_previous_action():
    ''' Switch back to the previous Action, after creating a pose asset :file: addons/pose_library/operators.py\:178 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$178> _
