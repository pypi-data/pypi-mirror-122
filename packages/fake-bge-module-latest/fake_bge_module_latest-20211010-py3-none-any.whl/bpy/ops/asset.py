...
def assign_action():
    ''' Set this pose Action as active Action on the active Object :file: addons/pose_library/operators.py\:212 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$212> _
