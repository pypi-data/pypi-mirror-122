...
def apply_pose_asset_for_keymap():
    ''' Apply the given Pose Action to the rig :file: addons/pose_library/operators.py\:396 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$396> _
...
def blend_pose_asset_for_keymap():
    ''' Blend the given Pose Action to the rig :file: addons/pose_library/operators.py\:374 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$374> _
...
def convert_old_poselib():
    ''' Create a pose asset for each pose marker in the current action :file: addons/pose_library/operators.py\:418 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$418> _
...
def paste_asset():
    ''' Paste the Asset that was previously copied using Copy As Asset :file: addons/pose_library/operators.py\:267 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$267> _
...
def restore_previous_action():
    ''' Switch back to the previous Action, after creating a pose asset :file: addons/pose_library/operators.py\:162 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$162> _
