...
class RDSDBSubnetGroup(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=sCMWu,**kwargs):
...
class RDSDBCluster(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return sCMWw(RDSDBCluster,self).get_cfn_attribute(attribute)
 @sCMWE
 def get_deploy_templates():
...
class RDSDBInstance(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return sCMWw(RDSDBInstance,self).get_cfn_attribute(attribute)
 @sCMWb
 ...
 def get_deploy_templates():
  ...
  return{"create":{"function":"create_db_instance","parameters":attrs+[{"VpcSecurityGroupIds":"VPCSecurityGroups"}],"types":{"AllocatedStorage":sCMWt}},"delete":{"function":"delete_db_instance","parameters":["DBInstanceIdentifier"]}}
