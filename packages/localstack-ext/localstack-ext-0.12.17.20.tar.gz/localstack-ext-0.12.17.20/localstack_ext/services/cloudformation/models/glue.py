...
class GlueTrigger(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return pxNeo(GlueTrigger,self).get_cfn_attribute(attribute_name)
class GlueWorkflow(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ATTRS:
   return self.props.get("Name")
  return pxNeo(GlueWorkflow,self).get_cfn_attribute(attribute_name)
class GlueJob(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return pxNeo(GlueJob,self).get_cfn_attribute(attribute_name)
class GlueCrawler(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ATTRS:
   return self.props["Name"]
  return pxNeo(GlueCrawler,self).get_cfn_attribute(attribute_name)
...
class GlueDatabase(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return pxNeo(GlueDatabase,self).get_cfn_attribute(attribute_name)
...
class GlueTable(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return pxNeo(GlueTable,self).get_cfn_attribute(attribute_name)
