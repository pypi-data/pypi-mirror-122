...
class SESTemplate(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return(template or[WRdvi])[0]
 def get_physical_resource_id(self,attribute=WRdvi,**kwargs):
 ...
 def update_resource(self,new_resource,stack_name,resources):
  ...
  if WRdvs(template.get(attr,"")==new_template.get(attr,"")for attr in["SubjectPart","TextPart","HtmlPart"]):
   return
