...
class RDSDBSubnetGroup(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=bjQeJ,**kwargs):
...
class RDSDBCluster(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return bjQeM(RDSDBCluster,self).get_cfn_attribute(attribute)
 @bjQer
 def get_deploy_templates():
...
class RDSDBInstance(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return bjQeM(RDSDBInstance,self).get_cfn_attribute(attribute)
 @bjQey
 ...
 def get_deploy_templates():
  ...
  return{"create":{"function":"create_db_instance","parameters":attrs+[{"VpcSecurityGroupIds":"VPCSecurityGroups"}],"types":{"AllocatedStorage":bjQed}},"delete":{"function":"delete_db_instance","parameters":["DBInstanceIdentifier"]}}
