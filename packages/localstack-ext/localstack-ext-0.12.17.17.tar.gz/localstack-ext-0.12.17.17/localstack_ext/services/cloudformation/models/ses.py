...
class SESTemplate(GenericBaseModel):
 ...
 def fetch_state(self,stack_name,resources):
  ...
  return(template or[OXVAE])[0]
 def get_physical_resource_id(self,attribute=OXVAE,**kwargs):
 ...
 def update_resource(self,new_resource,stack_name,resources):
  ...
  if OXVAw(template.get(attr,"")==new_template.get(attr,"")for attr in["SubjectPart","TextPart","HtmlPart"]):
   return
