...
class GlueTrigger(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return mvSCL(GlueTrigger,self).get_cfn_attribute(attribute_name)
class GlueWorkflow(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ATTRS:
   return self.props.get("Name")
  return mvSCL(GlueWorkflow,self).get_cfn_attribute(attribute_name)
class GlueJob(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return mvSCL(GlueJob,self).get_cfn_attribute(attribute_name)
class GlueCrawler(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ATTRS:
   return self.props["Name"]
  return mvSCL(GlueCrawler,self).get_cfn_attribute(attribute_name)
...
class GlueDatabase(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return mvSCL(GlueDatabase,self).get_cfn_attribute(attribute_name)
...
class GlueTable(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return mvSCL(GlueTable,self).get_cfn_attribute(attribute_name)
