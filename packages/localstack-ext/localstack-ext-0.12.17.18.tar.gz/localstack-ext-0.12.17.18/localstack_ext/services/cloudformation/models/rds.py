...
class RDSDBSubnetGroup(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=fmDBu,**kwargs):
...
class RDSDBCluster(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return fmDBS(RDSDBCluster,self).get_cfn_attribute(attribute)
 @fmDBx
 def get_deploy_templates():
...
class RDSDBInstance(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return fmDBS(RDSDBInstance,self).get_cfn_attribute(attribute)
 @fmDBn
 ...
 def get_deploy_templates():
  ...
  return{"create":{"function":"create_db_instance","parameters":attrs+[{"VpcSecurityGroupIds":"VPCSecurityGroups"}],"types":{"AllocatedStorage":fmDBN}},"delete":{"function":"delete_db_instance","parameters":["DBInstanceIdentifier"]}}
