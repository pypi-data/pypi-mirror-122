...
class KinesisAnalyticsApplicationOutput(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return IfVtU(KinesisAnalyticsApplicationOutput,self).get_cfn_attribute(attribute_name)
class KinesisAnalyticsApplication(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ID_ATTRS:
   ...
   if app_name:
    return app_name
  return IfVtU(KinesisAnalyticsApplication,self).get_cfn_attribute(attribute_name)
