...
class RDSDBSubnetGroup(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=Vxqfv,**kwargs):
...
class RDSDBCluster(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return Vxqfe(RDSDBCluster,self).get_cfn_attribute(attribute)
 @VxqfY
 def get_deploy_templates():
...
class RDSDBInstance(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return Vxqfe(RDSDBInstance,self).get_cfn_attribute(attribute)
 @VxqfO
 ...
 def get_deploy_templates():
  ...
  return{"create":{"function":"create_db_instance","parameters":attrs+[{"VpcSecurityGroupIds":"VPCSecurityGroups"}],"types":{"AllocatedStorage":Vxqfl}},"delete":{"function":"delete_db_instance","parameters":["DBInstanceIdentifier"]}}
