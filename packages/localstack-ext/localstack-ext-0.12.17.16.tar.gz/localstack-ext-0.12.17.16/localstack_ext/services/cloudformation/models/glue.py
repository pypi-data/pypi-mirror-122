...
class GlueTrigger(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return XmRwI(GlueTrigger,self).get_cfn_attribute(attribute_name)
class GlueWorkflow(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ATTRS:
   return self.props.get("Name")
  return XmRwI(GlueWorkflow,self).get_cfn_attribute(attribute_name)
class GlueJob(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return XmRwI(GlueJob,self).get_cfn_attribute(attribute_name)
class GlueCrawler(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  if attribute_name in REF_ATTRS:
   return self.props["Name"]
  return XmRwI(GlueCrawler,self).get_cfn_attribute(attribute_name)
...
class GlueDatabase(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return XmRwI(GlueDatabase,self).get_cfn_attribute(attribute_name)
...
class GlueTable(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute_name):
  ...
  return XmRwI(GlueTable,self).get_cfn_attribute(attribute_name)
