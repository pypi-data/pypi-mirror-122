...
class RDSDBSubnetGroup(GenericBaseModel):
 ...
 def get_physical_resource_id(self,attribute=HDhQu,**kwargs):
...
class RDSDBCluster(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return HDhQl(RDSDBCluster,self).get_cfn_attribute(attribute)
 @HDhQj
 def get_deploy_templates():
...
class RDSDBInstance(GenericBaseModel):
 ...
 def get_cfn_attribute(self,attribute):
  ...
  return HDhQl(RDSDBInstance,self).get_cfn_attribute(attribute)
 @HDhQX
 ...
 def get_deploy_templates():
  ...
  return{"create":{"function":"create_db_instance","parameters":attrs+[{"VpcSecurityGroupIds":"VPCSecurityGroups"}],"types":{"AllocatedStorage":HDhQp}},"delete":{"function":"delete_db_instance","parameters":["DBInstanceIdentifier"]}}
