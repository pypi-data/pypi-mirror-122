...
def parse(hub, functions: Dict[str, CloudSpecFunction]):
    funcs = {}
    for function_name in ("present", "absent", "describe"):
        ...
        funcs[function_name] = dict(
            function=dict(
                ...
                doc=doc,
                header_params=hub.cloudspec.parse.param.headers(function_data.params),
