...
class AppWindow(QtGui.QMainWindow, layout.Ui_MainWindow):
	...
	def loginScreen(self):
		...
		try:	# 167.71.230.181 expeyes.scischool.in
			...
			self.socklib.joinRoom(self.room)
			self.loggedIn = True
	...
	def prepareRemoteMonitorWidgetList(self,location):
		...
		self.socklib.addMonitors(location.findChildren((QtGui.QCheckBox,QtGui.QPushButton,QtGui.QSlider,QtGui.QLabel,pg.PlotWidget,QtGui.QStackedWidget,QtGui.QComboBox)),remote=True)
