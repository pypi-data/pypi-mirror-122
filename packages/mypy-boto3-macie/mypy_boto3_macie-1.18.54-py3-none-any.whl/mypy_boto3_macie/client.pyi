...
class MacieClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client)
    ...
    def associate_member_account(self, *, memberAccountId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client.associate_member_account)
    ...
    def associate_s3_resources(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client.associate_s3_resources)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client.can_paginate)
    ...
    def disassociate_member_account(self, *, memberAccountId: str) -> None:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client.disassociate_member_account)
    ...
    def disassociate_s3_resources(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client.disassociate_s3_resources)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client.generate_presigned_url)
    ...
    def list_member_accounts(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client.list_member_accounts)
    ...
    def list_s3_resources(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client.list_s3_resources)
    ...
    def update_s3_resources(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Client.update_s3_resources)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Paginator.ListMemberAccounts)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/macie.html#Macie.Paginator.ListS3Resources)
