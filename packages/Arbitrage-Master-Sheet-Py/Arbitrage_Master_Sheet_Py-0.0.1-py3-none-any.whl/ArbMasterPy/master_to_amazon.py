...
import sys
from Excelutilities.importing_data_helpers import is_col_block_bool
from Excelutilities import index_helpers
first_and_last_row_index = index_helpers.first_and_last_row_index
is_from_single_col = index_helpers.is_from_single_col
...
def export_data():
    ...
    default_file_loc = r"C:\Users\ethan\Documents\master_sheet.xlsm"
    ...
    while is_from_single_col(current_address) == False:
    ...
    first_and_lasts = [first_and_last_row_index(block) for block in current_address.split(",")]
    ...
    src_path = r"C:\Users\ethan\Downloads\james example.xlsm"
    dest_path = r"C:\Users\ethan\Downloads\james example2.xlsm"
