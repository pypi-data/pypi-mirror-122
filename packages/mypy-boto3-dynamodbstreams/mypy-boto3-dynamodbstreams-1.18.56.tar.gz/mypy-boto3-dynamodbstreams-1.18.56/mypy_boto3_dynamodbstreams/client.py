...
class DynamoDBStreamsClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/dynamodbstreams.html#DynamoDBStreams.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/dynamodbstreams.html#DynamoDBStreams.Client.can_paginate)
    ...
    def describe_stream(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/dynamodbstreams.html#DynamoDBStreams.Client.describe_stream)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/dynamodbstreams.html#DynamoDBStreams.Client.generate_presigned_url)
    ...
    def get_records(self, *, ShardIterator: str, Limit: int = ...) -> GetRecordsOutputTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/dynamodbstreams.html#DynamoDBStreams.Client.get_records)
    ...
    def get_shard_iterator(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/dynamodbstreams.html#DynamoDBStreams.Client.get_shard_iterator)
    ...
    def list_streams(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/dynamodbstreams.html#DynamoDBStreams.Client.list_streams)
