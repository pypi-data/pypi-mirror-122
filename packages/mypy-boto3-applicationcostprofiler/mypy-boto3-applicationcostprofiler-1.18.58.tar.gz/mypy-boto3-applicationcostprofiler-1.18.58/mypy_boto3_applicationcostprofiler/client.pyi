...
class ApplicationCostProfilerClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Client.can_paginate)
    ...
    def delete_report_definition(self, *, reportId: str) -> DeleteReportDefinitionResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Client.delete_report_definition)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Client.generate_presigned_url)
    ...
    def get_report_definition(self, *, reportId: str) -> GetReportDefinitionResultTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Client.get_report_definition)
    ...
    def import_application_usage(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Client.import_application_usage)
    ...
    def list_report_definitions(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Client.list_report_definitions)
    ...
    def put_report_definition(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Client.put_report_definition)
    ...
    def update_report_definition(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Client.update_report_definition)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.58/reference/services/applicationcostprofiler.html#ApplicationCostProfiler.Paginator.ListReportDefinitions)
