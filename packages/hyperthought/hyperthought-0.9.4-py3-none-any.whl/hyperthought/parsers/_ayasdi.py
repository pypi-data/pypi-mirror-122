...
class Ayasdi(BaseParser):
    ...
    The flattened metadata then be transformed to the API format.
        [
            {
                "keyName": "a/b/_0",
                "value": {
    ...
    def parse(self):
        exception_message = 'An Ayasdi file must contain JSON with a "meta" key.'
        ...
        self.metadata = [
            ...
            for key, value in parser_utils.flatten.flatten(data['meta']).items()
        ]
