...
class UnionFind:
    ...
    The modification involves translation from an arbitrary identifier to a list
    index.  The identifier will be obtained via the get_id function (constructor
    parameter) applied to a data object passed to one of the public methods.
    ...
    def __init__(self, get_id=None):
        ...
        if not callable(get_id):
            return ValueError("get_id must be a callable")
