...
kernels = [
  ...
  ((2, 2, 2, 2), [0])             # Narrower kernel with widths (2,2,2,2) bins in PID,Pt,Eta,Ntracks 
...
config = {
  'h' :    {
            ...
            "ProbNNp"    : ("pi_Dstar2Dpi", "MC15TuneV1_ProbNNp", kernels),
  ...
  'lk' :   {
            ...
            "ProbNNp"    : ("K_Dstar2Dpi", "MC15TuneV1_ProbNNp", kernels),
            "pidk"       : ("K_Dstar2Dpi", "CombDLLK", kernels),
            "pidp"       : ("K_Dstar2Dpi", "CombDLLp", kernels),
           },
  'lp' :   {
            "ProbNNK"    : ("p_Lambda2ppi", "MC15TuneV1_ProbNNK", kernels),
            "ProbNNpi"   : ("p_Lambda2ppi", "MC15TuneV1_ProbNNpi", kernels),
            "ProbNNp"    : ("p_Lambda2ppi", "MC15TuneV1_ProbNNp", kernels),
            "prProbNNK"  : ("p_Lambda2ppi_Prompt", "MC15TuneV1_ProbNNK", kernels),
            "prProbNNpi" : ("p_Lambda2ppi_Prompt", "MC15TuneV1_ProbNNpi", kernels),
            "prProbNNp"  : ("p_Lambda2ppi_Prompt", "MC15TuneV1_ProbNNp", kernels),
           }
}
  ...
  for track, subst in config.items() :
    for var, (sample, calibvar, kernel_list) in subst.items() :
      ...
      resample(
         ...
         verbose = True,            # Print debugging information
