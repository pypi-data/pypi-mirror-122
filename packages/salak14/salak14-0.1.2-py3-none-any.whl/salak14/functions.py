...
def opencd(a):
    if platform == "linux" or platform == "linux2":
        ...
        ctypes.windll.WINMM.mciSendStringW(u"open "+a+": type cdaudio alias "+a+"_drive", None, 0, None)
        ctypes.windll.WINMM.mciSendStringW(u"set "+a+"_drive door open", None, 0, None)
...
def closecd(a):
    if platform == "linux" or platform == "linux2":
        ...
        ctypes.windll.WINMM.mciSendStringW(u"open "+a+": type cdaudio alias "+a+"_drive", None, 0, None)
        ctypes.windll.WINMM.mciSendStringW(u"set "+a+"_drive door closed", None, 0, None)
