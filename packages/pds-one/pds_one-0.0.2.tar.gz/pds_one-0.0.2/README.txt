...
1.4.0
Добавлен тестовый режим, при передаче test_mode=True, porDataSplitter не будет подключаться к порту, а будет
просто рассылать test_value (по умолчанию b'101010')

2.0.0
Подключен модуль GCSE (WITAPI)