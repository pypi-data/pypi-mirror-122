...
class env:
    ...
    def get_state(self):
        ...
        for obj in self.enemy_sprites:
            ...
            enemies.append((obj.rect.centerx,obj.rect.centery))
            enemies.sort(key=takeSecond, reverse=False)
        
        for enemy in enemies:
            self.state.append(enemy[0]-self.player.rect.centerx) #),obj.y_speed\
