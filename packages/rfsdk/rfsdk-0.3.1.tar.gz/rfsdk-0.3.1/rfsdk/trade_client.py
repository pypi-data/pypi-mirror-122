...
class TradeClient(object):
    ...
    def login(self,
        ...
        req = account_req.make_login_req(login=trade_login_req, qsid=qsid, wtid=wtid)
    ...
    def logout(self):
        ...
        account_logout_req = account_req.make_logout_req(investor_key=self._investor_key)
    ...
    def query_position(self,
        ...
        req = trade_req.make_query_position_detail_req(investor_key=self._investor_key,
                                                       ...
                                                       historical_date=historical_date,
                                                       client_id=client_id)
        return ant.async_call(SERVICE_TRADER_FUTURES, METHOD_TRADER_QUERY_POSITION, req)
    ...
    def query_margin_rate_req(self,
                              instrument_id,
