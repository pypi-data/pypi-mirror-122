    ...
    public submitPackage = async () => {
        ...
        if (current != null) {
            ...
            ServerConnection.makeRequest(
                ...
                if (body) {
                    this._packages.get(optumi.metadata.nbKey).push(new Package(new Date(), optumi.metadata.nbKey, body.label, PackageState.ACCEPTED, notebook, optumi.config, null, null, body.auto))
