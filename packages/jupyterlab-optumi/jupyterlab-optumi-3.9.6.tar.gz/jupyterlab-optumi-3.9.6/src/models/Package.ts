...
export class Package {
    ...
    constructor(timestamp: Date, nbKey: string, label: string, packageState: PackageState, originalNotebook: any, originalConfig: OptumiConfig, optimizedNotebook: any, optimizedConfig: OptumiConfig, auto: boolean) {
