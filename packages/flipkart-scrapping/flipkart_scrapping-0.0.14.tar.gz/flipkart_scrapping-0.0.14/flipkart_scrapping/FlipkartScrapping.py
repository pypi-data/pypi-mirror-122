...
class __flipkartScrap:
    ...
    def process(self, product, to_file, to_mongo, details, options={}):
    ...
    def to_file(self, product, file, options):
        details = {"file" : file}
        self.process(product, to_file=True, to_mongo=False, details=details, options=options)
    
    def to_mongo(self, product, options):
        details = {
            "username" : "username",
            "password" : "password",
            "db_name" : "db_name",
        ...
        self.process(product, to_file=False, to_mongo=True, details=details, options=options)
