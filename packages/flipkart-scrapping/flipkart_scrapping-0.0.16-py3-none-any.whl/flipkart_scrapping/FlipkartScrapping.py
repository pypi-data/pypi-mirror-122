...
class __flipkartScrap:
    ...
    def processProductDetails(self, request_url : str):
        ...
        name = prod_info["product"].split("(")[0].replace("-", "").strip()
    ...
    def process(self, product, to_file, to_mongo, details, params={}):
        ...
        while no_of_products >= 0:
            ...
            for url in prod_urls:
                ...
                p_name = p_name.lower().strip().replace(" ", "-")
    ...
    def to_file(self, product, file, params={}):
        details = {"file" : file}
        self.process(product, to_file=True, to_mongo=False, details=details, params=params)
    
    def to_mongo(self, product, params={}):
        details = {
            "username" : "username",
            "password" : "password",
            "db_name" : "db_name",
        ...
        self.process(product, to_file=False, to_mongo=True, details=details, params=params)

fp_scrap = __flipkartScrap
