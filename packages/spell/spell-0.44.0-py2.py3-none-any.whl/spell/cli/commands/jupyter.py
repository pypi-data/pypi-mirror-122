...
from spell.cli.utils.dependencies import format_pip_versions, format_apt_versions
...
def jupyter(
    ...
    **kwargs
    ...
    env = Environment(
        ...
        pip_env=format_pip_versions(run_req.pip_env_packages),
        requirements_file=run_req.requirements_file,
        pip=format_pip_versions(run_req.pip_packages),
