...
class RDSDataServiceClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/rds-data.html#RDSDataService.Client)
    ...
    def batch_execute_statement(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/rds-data.html#RDSDataService.Client.batch_execute_statement)
    ...
    def begin_transaction(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/rds-data.html#RDSDataService.Client.begin_transaction)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/rds-data.html#RDSDataService.Client.can_paginate)
    ...
    def commit_transaction(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/rds-data.html#RDSDataService.Client.commit_transaction)
    ...
    def execute_sql(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/rds-data.html#RDSDataService.Client.execute_sql)
    ...
    def execute_statement(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/rds-data.html#RDSDataService.Client.execute_statement)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/rds-data.html#RDSDataService.Client.generate_presigned_url)
    ...
    def rollback_transaction(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.54/reference/services/rds-data.html#RDSDataService.Client.rollback_transaction)
