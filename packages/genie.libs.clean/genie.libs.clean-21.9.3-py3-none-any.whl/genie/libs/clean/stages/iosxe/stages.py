...
from genie.libs.clean.stages.stages import PingServer as BasePingServer
from genie.libs.clean.stages.stages import CopyToLinux as BaseCopyToLinux
from genie.libs.clean.stages.stages import CopyToDevice as BaseCopyToDevice
from genie.libs.clean.stages.stages import WriteErase as BaseWriteErase
from genie.libs.clean.stages.stages import Reload as BaseReload
from genie.libs.clean.stages.stages import ApplyConfiguration as BaseApplyConfiguration
from genie.libs.clean.stages.stages import VerifyRunningImage as BaseVerifyRunningImage
from genie.libs.clean.stages.stages import BackupFileOnDevice as BaseBackupFileOnDevice
from genie.libs.clean.stages.stages import DeleteBackupFromDevice as BaseDeleteBackupFromDevice
from genie.libs.clean.stages.stages import DeleteFilesFromServer as BaseDeleteFilesFromServer
from genie.libs.clean.stages.stages import RevertVmSnapshot as BaseRevertVmSnapshot
...
class PingServer(BasePingServer):
    __doc__ = BasePingServer.__doc__
    pass

class CopyToLinux(BaseCopyToLinux):
    __doc__ = BaseCopyToLinux.__doc__
    pass

class CopyToDevice(BaseCopyToDevice):
    __doc__ = BaseCopyToDevice.__doc__
    pass

class WriteErase(BaseWriteErase):
    __doc__ = BaseWriteErase.__doc__
    pass

class Reload(BaseReload):
    __doc__ = BaseReload.__doc__
    pass

class ApplyConfiguration(BaseApplyConfiguration):
    __doc__ = BaseApplyConfiguration.__doc__
    pass

class VerifyRunningImage(BaseVerifyRunningImage):
    __doc__ = BaseVerifyRunningImage.__doc__
    pass

class BackupFileOnDevice(BaseBackupFileOnDevice):
    __doc__ = BaseBackupFileOnDevice.__doc__
    pass

class DeleteBackupFromDevice(BaseDeleteBackupFromDevice):
    __doc__ = BaseDeleteBackupFromDevice.__doc__
    pass

class DeleteFilesFromServer(BaseDeleteFilesFromServer):
    __doc__ = BaseDeleteFilesFromServer.__doc__
    pass

class RevertVmSnapshot(BaseRevertVmSnapshot):
    __doc__ = BaseRevertVmSnapshot.__doc__
    pass
class PowerCycle(BasePowerCycle):
    __doc__ = BasePowerCycle.__doc__
    pass
