...
class NginxConfigHandler(MiddlewareConfigHandler):
    def __init__(self):
        ...
        self.permit_keys = ("commander_port", "commander_tenant_port", "k8s_proxy_port", "mysql_proxy_port", "minio_proxy_port", "identity_proxy_port", "mage_proxy_port", "chatbot_proxy_port")
