...
class IoTDataPlaneClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client.can_paginate)
    ...
    def delete_thing_shadow(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client.delete_thing_shadow)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client.generate_presigned_url)
    ...
    def get_retained_message(self, *, topic: str) -> GetRetainedMessageResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client.get_retained_message)
    ...
    def get_thing_shadow(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client.get_thing_shadow)
    ...
    def list_named_shadows_for_thing(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client.list_named_shadows_for_thing)
    ...
    def list_retained_messages(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client.list_retained_messages)
    ...
    def publish(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client.publish)
    ...
    def update_thing_shadow(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Client.update_thing_shadow)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.56/reference/services/iot-data.html#IoTDataPlane.Paginator.ListRetainedMessages)
