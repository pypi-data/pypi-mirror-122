...
class SageMakerRuntimeClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/sagemaker-runtime.html#SageMakerRuntime.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/sagemaker-runtime.html#SageMakerRuntime.Client.can_paginate)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/sagemaker-runtime.html#SageMakerRuntime.Client.generate_presigned_url)
    ...
    def invoke_endpoint(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/sagemaker-runtime.html#SageMakerRuntime.Client.invoke_endpoint)
    ...
    def invoke_endpoint_async(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.55/reference/services/sagemaker-runtime.html#SageMakerRuntime.Client.invoke_endpoint_async)
