...
class Executor(base_executor.BaseExecutor):
  ...
  def Do(self, input_dict: Dict[Text, List[types.Artifact]],
    ...
    logging.info("***************** Yulong 20211008 v1.2.2 Pusher start.")
    print("***************** Yulong 20211008 v1.2.2 Pusher start.")
...
#                           spec=V1beta1InferenceServiceSpec(predictor=predictor_create))
    ...
    logging.info("***************** Yulong 20211008 Pusher end.")
    print("***************** Yulong 20211008 Pusher end.")
