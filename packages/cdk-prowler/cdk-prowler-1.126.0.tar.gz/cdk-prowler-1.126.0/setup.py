    ...
    """
{
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.assertions>=1.126.0, <2.0.0",
        "aws-cdk.aws-codebuild>=1.126.0, <2.0.0",
        "aws-cdk.aws-events-targets>=1.126.0, <2.0.0",
        ...
        "aws-cdk.aws-s3-assets>=1.126.0, <2.0.0",
