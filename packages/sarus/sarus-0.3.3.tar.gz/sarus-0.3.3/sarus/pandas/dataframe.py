        ...
        **kwargs,
        ...
        if target_epsilon == 0.0:
            ...
            if response["status"] == "SUCCESS":
                ...
                result = {name_mapping[col]: avg for col, avg in result.items()}
        ...
        **kwargs,
        ...
        if target_epsilon == 0.0:
            ...
            if response["status"] == "SUCCESS":
                ...
                result = {name_mapping[col]: std for col, std in result.items()}
                return pd.Series(result)
            else:
                raise Exception(f"The query {query} failed.")
        ...
        **kwargs,
        ...
        if target_epsilon == 0.0:
            ...
            if response["status"] == "SUCCESS":
                ...
                result = {name_mapping[col]: sum for col, sum in result.items()}
                return pd.Series(result)
            else:
                raise Exception(f"The query {query} failed.")
