    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.6.1 fwBuild=06/10/2021-19:04:57 fwHash=0x864EB6E6 fwDirty=0 kmodVersion=0.6.1 kmodBuild=06/10/2021-19:04:57 kmodHash=0x864EB6E6 kmodDirty=0 swVersion=0.6.1 swBuild=06/10/2021-19:04:57 swHash=0x864EB6E6 swDirty=0"
                if build != build_ref:
