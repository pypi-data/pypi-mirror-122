    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.6.1 fwBuild=06/10/2021-19:03:35 fwHash=0xBC381F79 fwDirty=0 kmodVersion=0.6.1 kmodBuild=06/10/2021-19:03:35 kmodHash=0xBC381F79 kmodDirty=0 swVersion=0.6.1 swBuild=06/10/2021-19:03:35 swHash=0xBC381F79 swDirty=0"
                if build != build_ref:
