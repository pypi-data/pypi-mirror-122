    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.6.0 fwBuild=03/10/2021-16:43:36 fwHash=0xF6CAF6BB fwDirty=0 kmodVersion=0.6.0 kmodBuild=03/10/2021-16:43:36 kmodHash=0xF6CAF6BB kmodDirty=0 swVersion=0.6.0 swBuild=03/10/2021-16:43:36 swHash=0xF6CAF6BB swDirty=0"
                if build != build_ref:
