    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.6.0 fwBuild=03/10/2021-16:45:54 fwHash=0x104D87E4 fwDirty=0 kmodVersion=0.6.0 kmodBuild=03/10/2021-16:45:54 kmodHash=0x104D87E4 kmodDirty=0 swVersion=0.6.0 swBuild=03/10/2021-16:45:54 swHash=0x104D87E4 swDirty=0"
                if build != build_ref:
