from mangas_origines.exceptions.exceptions import ChapterDoesNotExist
...
class Scan:
    ...
    """
    def __init__(
            self, headers: dict, scan_id: int, name_id: str, url: str, genres: dict,
    ...
    async def __get_chapter(self, chapter_url: str) -> Chapter:
        ...
        return Chapter(
            self.headers, chapter_url, chapter, images_list
        )
