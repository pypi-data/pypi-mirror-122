...
class DLLauncherBatchOp(BatchOperator):
    ...
    def setScript(self, val):
        return self._add_param('script', val)
    ...
    def setUserDefinedParams(self, val):
        return self._add_param('userDefinedParams', val)
...
class DeepARPreProcessBatchOp(BatchOperator):
    CLS_NAME = 'com.alibaba.alink.operator.batch.timeseries.DeepARPreProcessBatchOp'
    OP_TYPE = 'FUNCTION'
