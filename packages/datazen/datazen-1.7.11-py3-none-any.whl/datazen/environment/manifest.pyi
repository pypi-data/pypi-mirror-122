...
class ManifestEnvironment(ConfigEnvironment, TemplateEnvironment):
    ...
    def load_manifest_reent(self, path: str, manifest_dir: str, params: dict, files: List[str]) -> Tuple[dict, bool]: ...
    def load_manifest(self, path: str = ...) -> bool: ...

def get_manifest_schema(require_all: bool = ...) -> Validator: ...
