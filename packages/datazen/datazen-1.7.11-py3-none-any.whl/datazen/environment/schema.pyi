...
class SchemaEnvironment(BaseEnvironment):
    def load_schema_types(self, sch_loads: LOADTYPE = ..., name: str = ...) -> dict: ...
    def load_schemas(self, require_all: bool = ..., sch_loads: LOADTYPE = ..., sch_types_loads: LOADTYPE = ..., name: str = ..., modify_registry: bool = ...) -> dict: ...
    def enforce_schemas(self, data: dict, require_all: bool = ..., sch_loads: LOADTYPE = ..., sch_types_loads: LOADTYPE = ..., name: str = ...) -> bool: ...
