...
def init(config, port=51723, key=None):
    """
    ...
    'redis-pw.conf' doesn't exist, it will be created. Don't rely too
    heavily on the default port, since any two apps using sync with the
    default port on the same machine will collide.
    """
