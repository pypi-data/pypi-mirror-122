...
def powerLaw(q, d, A):
    ...
    For q=0 the functionis undefined
...
def wormlikeChain(q, N, a, R=None, SLD=1, solventSLD=0, rtol=0.02):
    ...
    Examples
    --------
    Kratky and S(q) representation shoing the transition to high q. The high q limit is linear in q.
    ::
...
def idealHelix(q, L=3, R=0.3, P=0.54, n=3.6*3, Rot=None):
    ...
    if q.ndim == 1:
        ...
        q0 = np.r_[0, q]
        fq, err = formel.sphereAverage(function=_idealhelix_r, Q=q0, N=N, R=R, P=P, n=n,
