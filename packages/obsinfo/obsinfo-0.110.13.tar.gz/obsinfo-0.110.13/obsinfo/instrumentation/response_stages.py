...
class ResponseStages():
    ...
    def __init__(self, attribute_list, channel_modif={}, selected_config={},
        ...
        :param channel_modif (dict or :class:`.ObsMetadata`): channel
            modifications inherited from station
        :param selected_config (dict or :class:`.ObsMetadata`): configuration
            description to override or complement default values
        :param delay_correction (float): used only for datalogger: the delay
