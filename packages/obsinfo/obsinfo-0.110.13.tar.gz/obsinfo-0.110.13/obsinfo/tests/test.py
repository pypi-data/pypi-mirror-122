...
class TestObsinfo(unittest.TestCase):
    ...
    def test_dp_filters(self):
        """
        Test all information files in DATAPATH/{sensors, dataloggers, preamplifiers}/responses/filters
...
f" File: '{info_file}'. Computed result: {read_dict} and expected result: {expected_result.get(ftype, None)} are different")
    ...
    def test_dp_stages(self):
        """
        Test all information files in each response subdirectory.
        """
        failed_test = False
        for dir in self.infofiles_path.datapath_list:
            files_in_validate_dir = Path(dir).joinpath(
    ...
    def test_dp_components(self):
        """
        Test all information files in {DATAPATH}/{sensors, preamplifiers, dataloggers}
        """
        components_list = [
            "sensors",
            "preamplifiers",
    ...
    def test_dp_networks(self):
        """
        Test all information files in {DATAPATH}/network directories
        """ 
        for dir in self.infofiles_path.datapath_list:
