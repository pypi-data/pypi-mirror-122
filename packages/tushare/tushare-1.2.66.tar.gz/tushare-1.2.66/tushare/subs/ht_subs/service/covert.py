...
def convert_tick_stock(md_stock):
    ...
    inst.OpenInt = md_stock.get('OpenInterest')    # 可能没有
    inst.Volume = md_stock.get('TotalVolumeTrade')
    inst.Amount = md_stock.get('TotalValueTrade')
    inst.Num = md_stock.get('NumTrades')
    inst.AskPrice1 = md_stock.get('BuyPriceQueue')[0]
    inst.AskPrice2 = md_stock.get('BuyPriceQueue')[1]
    inst.AskPrice3 = md_stock.get('BuyPriceQueue')[2]
    inst.AskPrice4 = md_stock.get('BuyPriceQueue')[3]
    inst.AskPrice5 = md_stock.get('BuyPriceQueue')[4]
    inst.AskVolume1 = md_stock.get('BuyOrderQtyQueue')[0]
    inst.AskVolume2 = md_stock.get('BuyOrderQtyQueue')[1]
    inst.AskVolume3 = md_stock.get('BuyOrderQtyQueue')[2]
    inst.AskVolume4 = md_stock.get('BuyOrderQtyQueue')[3]
    inst.AskVolume5 = md_stock.get('BuyOrderQtyQueue')[4]
    inst.BidPrice1 = md_stock.get('SellPriceQueue')[0]
    inst.BidPrice2 = md_stock.get('SellPriceQueue')[1]
    inst.BidPrice3 = md_stock.get('SellPriceQueue')[2]
    inst.BidPrice4 = md_stock.get('SellPriceQueue')[3]
    inst.BidPrice5 = md_stock.get('SellPriceQueue')[4]
    inst.BidVolume1 = md_stock.get('SellOrderQtyQueue')[0]
    inst.BidVolume2 = md_stock.get('SellOrderQtyQueue')[1]
    inst.BidVolume3 = md_stock.get('SellOrderQtyQueue')[2]
    inst.BidVolume4 = md_stock.get('SellOrderQtyQueue')[3]
    inst.BidVolume5 = md_stock.get('SellOrderQtyQueue')[4]
    return inst.to_list()
...
def convert_tick_index(md_index):
    ...
    inst.OpenInt = md_index.get('OpenInterest')    # 可能没有
...
def convert_tick_option(md_option):
    ...
    inst.OpenInt = md_option.get('OpenInterest')    # 可能没有
...
def convert_tick_future(md_future):
    ...
    inst.OpenInt = md_future.get('OpenInterest')    # 可能没有
