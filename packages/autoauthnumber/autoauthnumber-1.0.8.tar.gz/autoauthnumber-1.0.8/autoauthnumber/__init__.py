...
import autoauthnumber.auto_AUTHNumber as auto_AUTHNumber
...
get_pronouncation=auto_AUTHNumber.get_pronouncation
make_pronouncation=auto_AUTHNumber.make_pronouncation
