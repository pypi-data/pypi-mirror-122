...
def _resolve_azure_access_token(scope, sp):
    """
    ...
    _print_and_log('Resolving access token for scope "{}" using identity of type "{}".'.format(scope, identity_type.name))
    ...
    if identity_type == _IdentityType.MANAGED:
        ...
        if is_obo_enabled == "True":
            ...
            if obo_endpoint:
                ...
                _print_and_log('No obo endpoint found in job environment variables.')
                _raise_obo_error()
        else:
            ...
            logger.info('Using interactive sign-in: tenant_id={}, timeoust_sec={}, always_use_device_code={}'.format(tenant_id, timeout_sec, always_use_device_code))
