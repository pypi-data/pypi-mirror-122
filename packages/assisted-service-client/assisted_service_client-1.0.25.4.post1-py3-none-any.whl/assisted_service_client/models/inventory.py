...
class Inventory(object):
    ...
    def __init__(self, hostname=None, bmc_address=None, interfaces=None, disks=None, boot=None, system_vendor=None, bmc_v6address=None, memory=None, cpu=None, timestamp=None, gpus=None, routes=None):  # noqa: E501
