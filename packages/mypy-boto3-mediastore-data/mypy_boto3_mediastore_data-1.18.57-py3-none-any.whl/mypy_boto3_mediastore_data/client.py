...
class MediaStoreDataClient(BaseClient):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/mediastore-data.html#MediaStoreData.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/mediastore-data.html#MediaStoreData.Client.can_paginate)
    ...
    def delete_object(self, *, Path: str) -> Dict[str, Any]:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/mediastore-data.html#MediaStoreData.Client.delete_object)
    ...
    def describe_object(self, *, Path: str) -> DescribeObjectResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/mediastore-data.html#MediaStoreData.Client.describe_object)
    ...
    def generate_presigned_url(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/mediastore-data.html#MediaStoreData.Client.generate_presigned_url)
    ...
    def get_object(self, *, Path: str, Range: str = ...) -> GetObjectResponseTypeDef:
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/mediastore-data.html#MediaStoreData.Client.get_object)
    ...
    def list_items(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/mediastore-data.html#MediaStoreData.Client.list_items)
    ...
    def put_object(
        ...
        *,
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/mediastore-data.html#MediaStoreData.Client.put_object)
    ...
    def get_paginator(self, operation_name: Literal["list_items"]) -> ListItemsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.18.57/reference/services/mediastore-data.html#MediaStoreData.Paginator.ListItems)
