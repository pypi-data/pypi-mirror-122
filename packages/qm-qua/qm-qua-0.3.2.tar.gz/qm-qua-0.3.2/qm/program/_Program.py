...
class _Program:
    ...
    def _declare_var(self, name, var_type, size, value, dim):
    ...
    def declare_int(self, name, size, value, dim):
        self._declare_var(name, QuaProgram.INT, size, value, dim)

    def declare_real(self, name, size, value, dim):
        self._declare_var(name, QuaProgram.REAL, size, value, dim)

    def declare_bool(self, name, size, value, dim):
        self._declare_var(name, QuaProgram.BOOL, size, value, dim)
