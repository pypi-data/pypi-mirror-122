...
class Project(object):
    ...
    def __init__(self, name=None, description=None, cloud_id=None, initial_cluster_config=None, id=None, created_at=None, creator_id=None, is_owner=None, directory_name=None, cloud=None, last_used_cloud_id=None, active_sessions=None, last_activity_at=None, owners=[], local_vars_configuration=None):  # noqa: E501
