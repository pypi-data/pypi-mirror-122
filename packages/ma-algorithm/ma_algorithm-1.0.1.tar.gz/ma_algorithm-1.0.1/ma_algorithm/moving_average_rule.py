# -*- coding: utf-8 -*-
"""Session 1: Simple Moving Average Rule.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KgtvSVkbG4_wAzOMOYAtogS18sDcGekG
...
we can use Tesla (TSLA) and Apple (AAPL) with daily interval as case studies.  
"""
...
class portfolio:
  ...
  def portfolios(self):
    ...
    ax1.set_title("Visualization of #"+ self.topic +" Portfolio Flows",fontsize=20)
    ...
    ax2.set_title("Comparison of #" + self.topic + " ROI on SMA and Simple Buy&Hold Strategy",fontsize=20)
    ...
    ax3.set_title("Comparison of #" + self.topic +" Sharpe Ratio on SMA and Simple Buy&Hold Strategy",fontsize=20)
    ax3.set_ylabel('Sharpe Ratio',fontsize=20)
